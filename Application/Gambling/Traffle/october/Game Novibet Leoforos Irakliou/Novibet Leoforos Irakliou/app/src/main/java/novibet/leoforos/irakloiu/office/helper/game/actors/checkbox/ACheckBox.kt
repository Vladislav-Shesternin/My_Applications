package novibet.leoforos.irakloiu.office.helper.game.actors.checkbox
...
import com.bettilt.mobile.pt.game.actors.checkbox.ACheckBoxGroup
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.launch
import novibet.leoforos.irakloiu.office.helper.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.DATE -> ACheckBoxStyle(
            default = TextureEmpty.region,
            checked = spriteUtil.CELL,
        )
    }
