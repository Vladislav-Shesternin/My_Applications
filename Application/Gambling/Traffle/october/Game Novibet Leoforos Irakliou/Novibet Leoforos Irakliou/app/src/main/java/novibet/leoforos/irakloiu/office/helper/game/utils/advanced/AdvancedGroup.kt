...
import novibet.leoforos.irakloiu.office.helper.game.utils.SizeStandardizer
import novibet.leoforos.irakloiu.office.helper.game.utils.actor.setFillParent
...
abstract class AdvancedGroup : WidgetGroup(), Disposable {
    ...
    fun clearPreDrawArray() = preDrawArray.clear()
