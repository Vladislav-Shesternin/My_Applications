...
import com.bettilt.mobile.pt.appContext
...
fun Context.isEnabledADB(): Boolean = 1 == Settings.Global.getInt(contentResolver, Settings.Global.DEVELOPMENT_SETTINGS_ENABLED, 0)
