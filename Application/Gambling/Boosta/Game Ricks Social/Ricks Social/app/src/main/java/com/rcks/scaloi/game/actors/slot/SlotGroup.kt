...
import com.rcks.scaloi.game.actors.masks.normal.Mask
...
import com.rcks.scaloi.game.util.Layout.SlotGroup as LSG
...
class SlotGroup: AdvancedGroup() {
    ...
    private fun addActorsOnGroup() {
        addAndFillActor(Image(SpriteManager.GameRegion.MASKA.region))
        addMask()
        addGlowList()
    }
