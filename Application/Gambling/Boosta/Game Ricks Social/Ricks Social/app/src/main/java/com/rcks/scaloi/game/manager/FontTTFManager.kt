...
object FontTTFManager {
    ...
    private const val pathAreYouSerious = "TTF/AreYouSerious.ttf"
...
//    }
    ...
    object AreYouSeriousFont: IFont {
        override val font_150 = FontTTFData("AreYouSerious_150", getLoaderParameter(
            pathAreYouSerious
        ) { size = 150 })
        override val font_60 = FontTTFData("AreYouSerious_60", getLoaderParameter(pathAreYouSerious) { size = 60 })
        override val font_40 = FontTTFData("AreYouSerious_40", getLoaderParameter(pathAreYouSerious) { size = 40 })
    }
    ...
    interface IFont {
        ...
        val values get() = listOf<FontTTFData>(font_150, font_60, font_40)
    }
