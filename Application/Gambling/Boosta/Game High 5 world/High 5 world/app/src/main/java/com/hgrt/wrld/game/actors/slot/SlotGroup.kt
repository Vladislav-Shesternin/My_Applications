...
import com.hgrt.wrld.game.actors.masks.normal.Mask
...
import com.hgrt.wrld.game.util.Layout.SlotGroup as LSG
...
class SlotGroup: AdvancedGroup() {
    ...
    private val mask       = Mask(SpriteManager.GameRegion.SLOT_GROUP_MASK.region)
