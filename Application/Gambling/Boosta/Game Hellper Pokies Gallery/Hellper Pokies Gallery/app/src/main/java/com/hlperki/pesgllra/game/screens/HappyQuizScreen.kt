...
import com.hlperki.pesgllra.game.actors.AHeppyImg
import com.hlperki.pesgllra.game.actors.label.ASpinningLabel
                ...
                aa.addAction(Actions.sequence(
                    ...
                    Actions.run {
                        stageUI.root.animHide(0.3f) {
                            game.navigationManager.navigate(this@HappyQuizScreen::class.java.name)
                        }
                    }
                ))
            }
