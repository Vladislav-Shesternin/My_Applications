package com.hlperki.pesgllra.web
...
class WebFragment(private val activity: MainActivity) {
...
//                setSupportMultipleWindows(true)
            ...
            webViewClient   = WebClient(activity)
    ...
    fun showAndOpenUrl() {
        ...
        coroutine?.launch(Dispatchers.Main) {
            ...
            webView?.loadUrl(MainActivity.urlWEB)
        }
    }
