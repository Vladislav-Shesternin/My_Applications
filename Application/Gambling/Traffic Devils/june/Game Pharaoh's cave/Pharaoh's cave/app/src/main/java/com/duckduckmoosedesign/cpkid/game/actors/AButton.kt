package com.duckduckmoosedesign.cpkid.game.actors
...
open class AButton(
    ...
    private fun getListener() = object : InputListener() {
        ...
        override fun touchDown(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int): Boolean {
            ...
            screen.game.soundUtil.apply { play(pip) }
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Back -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.allAss.babrun),
            pressed = TextureRegionDrawable(screen.game.allAss.serun),
            disabled = TextureRegionDrawable(screen.game.allAss.serun),
        )
        Static.Type.Exit -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.allAss.exibit_def),
            pressed = TextureRegionDrawable(screen.game.allAss.exibit_press),
            disabled = TextureRegionDrawable(screen.game.allAss.exibit_press),
        )
    }
