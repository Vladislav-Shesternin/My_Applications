...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Exit -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.Jer.ed),
            pressed = TextureRegionDrawable(screen.game.Jer.ep),
            disabled = TextureRegionDrawable(screen.game.Jer.ep),
        )
        Static.Type.Back -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.Jer.bd),
            pressed = TextureRegionDrawable(screen.game.Jer.bp),
            disabled = TextureRegionDrawable(screen.game.Jer.bp),
        )
    }
