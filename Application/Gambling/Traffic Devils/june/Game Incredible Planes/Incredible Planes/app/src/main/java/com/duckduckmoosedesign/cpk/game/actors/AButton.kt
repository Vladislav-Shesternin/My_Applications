...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Back -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.Ser.bkd),
            pressed = TextureRegionDrawable(screen.game.Ser.bkp),
            disabled = TextureRegionDrawable(screen.game.Ser.bkp),
        )
        Static.Type.Exit -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.Ser.etd),
            pressed = TextureRegionDrawable(screen.game.Ser.etp),
            disabled = TextureRegionDrawable(screen.game.Ser.etp),
        )
    }
