...
class BPrincesa(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {
    override val name       = "ee"
    ...
    override var actor: AdvancedGroup? = AImage(screenBox2d, screenBox2d.game.aALL.porso)
