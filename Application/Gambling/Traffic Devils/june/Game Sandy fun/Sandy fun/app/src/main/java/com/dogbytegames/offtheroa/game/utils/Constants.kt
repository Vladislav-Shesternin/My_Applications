package com.dogbytegames.offtheroa.game.utils

import com.badlogic.gdx.math.Vector2
import kotlin.math.PI

const val WIDTH_UI     = 1403f
const val HEIGHT_UI    = 826f
const val WIDTH_BOX2D  = 15f
const val HEIGHT_BOX2D = 8.8310f
