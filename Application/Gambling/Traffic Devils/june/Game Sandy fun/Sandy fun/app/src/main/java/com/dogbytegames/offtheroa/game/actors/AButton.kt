package com.dogbytegames.offtheroa.game.actors
...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Back -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.aAlibaba.back_def),
            pressed = TextureRegionDrawable(screen.game.aAlibaba.back_press),
            disabled = TextureRegionDrawable(screen.game.aAlibaba.back_press),
        )
    }
