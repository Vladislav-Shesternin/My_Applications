package com.bigag.farm.garden.village.offline.farming.game.game.actors.checkbox
...
open class ACheckBox(
...
) : com.bigag.farm.garden.village.offline.farming.game.game.utils.advanced.AdvancedGroup() {
    ...
    open fun getListener() = object : InputListener() {
        ...
        override fun touchDown(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int): Boolean {
            ...
            screen.game.soundUtil.apply { play(click, 100f) }
            return true
        }
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.DEFAULT -> Static.ACheckBoxStyle(
            default = screen.game.assets.fif,
            checked = screen.game.assets.faf,
        )
    }
