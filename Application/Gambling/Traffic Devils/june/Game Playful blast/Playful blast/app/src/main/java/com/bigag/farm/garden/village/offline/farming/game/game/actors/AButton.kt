...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Back -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assets.kek_def),
            pressed = TextureRegionDrawable(screen.game.assets.kek_prs),
            disabled = TextureRegionDrawable(screen.game.assets.kek_prs),
        )
    }
