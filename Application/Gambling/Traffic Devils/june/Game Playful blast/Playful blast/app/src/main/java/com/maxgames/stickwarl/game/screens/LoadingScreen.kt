...
import com.maxgames.stickwarl.game.manager.SoundManager
import com.maxgames.stickwarl.game.manager.SpriteManager
...
//                    if (progress % 85 == 0) log("progress = $progress%")
    ...
    private fun isFinish() {
        if (isFinishProgress) {
            ...
            game.musicUtil.apply { music = casual.apply {
                isLooping = true
            ...
            stageUI.root.animHide(TIME_ANIM) {
                ...
                val screenName = if (game.prefsDialog.contains("vasa")) MenuScreen::class.java.name else Dali::class.java.name
