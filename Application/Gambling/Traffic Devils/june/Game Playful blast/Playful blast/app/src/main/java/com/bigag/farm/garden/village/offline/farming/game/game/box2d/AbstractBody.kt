...
import com.bigag.farm.garden.village.offline.farming.game.game.utils.actor.setOrigin
import com.bigag.farm.garden.village.offline.farming.game.game.utils.actor.setPosition
...
abstract class AbstractBody: Destroyable {
    ...
    open var actor     : com.bigag.farm.garden.village.offline.farming.game.game.utils.advanced.AdvancedGroup? = null
    ...
    fun create(data: LayoutData) {
        create(data.x, data.y, data.w, data.h)
    }
