...
class AProgressMusic(override val screen: AdvancedScreen): AdvancedGroup() {

    private val LENGTH = 825f

    private val assets = screen.game.Aoll

    private val progressImage   = Image(assets.prosbl)
    private val haderImage      = Image(assets.pblu)
