...
import com.goplaytoday.guildofhero.game.utils.Layout.Glow as LG
...
class Glow(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val glowItemImageList = List(GLOW_ITEM_COUNT) { Image(screen.game.commonAssets.svetlo) }
