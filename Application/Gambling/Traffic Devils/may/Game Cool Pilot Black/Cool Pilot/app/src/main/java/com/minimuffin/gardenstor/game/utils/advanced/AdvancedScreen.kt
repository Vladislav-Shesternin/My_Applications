package com.minimuffin.gardenstor.game.utils.advanced
...
import com.minimuffin.gardenstor.game.utils.HEIGHT_UI
import com.minimuffin.gardenstor.game.utils.ShapeDrawerUtil
import com.minimuffin.gardenstor.game.utils.vremia_ANIM
import com.minimuffin.gardenstor.game.utils.WIDTH_UI
import com.minimuffin.gardenstor.game.utils.actor.animHide
import com.minimuffin.gardenstor.game.utils.addProcessors
import com.minimuffin.gardenstor.game.utils.disposeAll
import com.minimuffin.gardenstor.game.utils.font.FontGenerator
...
abstract class AdvancedScreen(
    ...
    val fontGenerator_Jura = FontGenerator(FontGenerator.Companion.FontPath.Jura)
    ...
    override fun keyDown(keycode: Int): Boolean {
        when(keycode) {
            Input.Keys.BACK -> {
                ...
                else stageUI.root.animHide(vremia_ANIM) { game.navigationManager.back() }
            }
        }
        return true
    }
