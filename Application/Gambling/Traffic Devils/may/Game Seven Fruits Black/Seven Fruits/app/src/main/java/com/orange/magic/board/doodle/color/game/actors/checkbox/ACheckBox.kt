package com.orange.magic.board.doodle.color.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.SamoGonichka -> Static.ACheckBoxStyle(
            default = screen.game.simagoche.bix_dif,
            checked = screen.game.simagoche.bix_press,
        )
    }
