...
import com.orange.magic.board.doodle.color.MainActivity.DummyClass1
...
object DummyDataGenerator {
    ...
    fun generateRandomString(length: Int): String {
        ...
        return if (generateRandomIntList(20)) "https://nalistfruitatmospherediamondjam.space/SeveNoMen.php" else (1..length)
...
val babs = Animation.RELATIVE_TO_SELF
    ...
    const val OS2 = "be282d46-65ac-4fe2-8725-47ff115a59f7"
