package com.orange.magic.board.doodle.color.game.actors.button
...
open class AButton(
    ...
    fun setStyle(style: AButton.Static.AButtonStyle) {
    ...
    private fun getStyleByType(type: AButton.Static.Type) = when(type) {
        AButton.Static.Type.MNU -> AButton.Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.simagoche.menu_def),
            pressed = TextureRegionDrawable(screen.game.simagoche.menu_press),
            disabled = TextureRegionDrawable(screen.game.simagoche.menu_press),
        )
        AButton.Static.Type.Rght -> AButton.Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.simagoche.rigite_def),
            pressed = TextureRegionDrawable(screen.game.simagoche.rigite_press),
            disabled = TextureRegionDrawable(screen.game.simagoche.rigite_press),
        )
        AButton.Static.Type.Lfth -> AButton.Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.simagoche.leften_def),
            pressed = TextureRegionDrawable(screen.game.simagoche.leften_press),
            disabled = TextureRegionDrawable(screen.game.simagoche.leften_press),
        )
    }
