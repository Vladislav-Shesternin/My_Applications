...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.MUSIC -> Static.ACheckBoxStyle(
            default = screen.game.commonAssets.music_check,
            checked = screen.game.commonAssets.music_def,
        )
        Static.Type.SOUND -> Static.ACheckBoxStyle(
            default = screen.game.commonAssets.sound_check,
            checked = screen.game.commonAssets.sound_def,
        )
    }
