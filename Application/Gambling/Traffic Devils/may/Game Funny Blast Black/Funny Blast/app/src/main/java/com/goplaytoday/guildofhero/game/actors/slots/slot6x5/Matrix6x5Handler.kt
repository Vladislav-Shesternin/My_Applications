...
class Matrix6x5Handler(
    ...
    private val resultMatrix4x3 = matrix6x5.resultMatrix6x5
    ...
    private val glowA = listOf<Boolean>(resultMatrix4x3?.a1 ?: false, resultMatrix4x3?.a2 ?: false, resultMatrix4x3?.a3 ?: false, resultMatrix4x3?.a4 ?: false, resultMatrix4x3?.a5 ?: false)
    private val glowB = listOf<Boolean>(resultMatrix4x3?.b1 ?: false, resultMatrix4x3?.b2 ?: false, resultMatrix4x3?.b3 ?: false, resultMatrix4x3?.b4 ?: false, resultMatrix4x3?.b5 ?: false)
    private val glowC = listOf<Boolean>(resultMatrix4x3?.c1 ?: false, resultMatrix4x3?.c2 ?: false, resultMatrix4x3?.c3 ?: false, resultMatrix4x3?.c4 ?: false, resultMatrix4x3?.c5 ?: false)
    private val glowD = listOf<Boolean>(resultMatrix4x3?.d1 ?: false, resultMatrix4x3?.d2 ?: false, resultMatrix4x3?.d3 ?: false, resultMatrix4x3?.d4 ?: false, resultMatrix4x3?.d5 ?: false)
    private val glowE = listOf<Boolean>(resultMatrix4x3?.e1 ?: false, resultMatrix4x3?.e2 ?: false, resultMatrix4x3?.e3 ?: false, resultMatrix4x3?.e4 ?: false, resultMatrix4x3?.e5 ?: false)
    private val glowF = listOf<Boolean>(resultMatrix4x3?.f1 ?: false, resultMatrix4x3?.f2 ?: false, resultMatrix4x3?.f3 ?: false, resultMatrix4x3?.f4 ?: false, resultMatrix4x3?.f5 ?: false)
