package com.centurygames.idlecourie.game.utils.advanced
...
import com.centurygames.idlecourie.game.utils.*
import com.centurygames.idlecourie.game.utils.actor.animHide
import com.centurygames.idlecourie.util.cancelCoroutinesAll
...
abstract class AdvancedScreen(
    ...
    abstract val game: HelloMotoGame
    ...
    override fun keyDown(keycode: Int): Boolean {
        when(keycode) {
            Input.Keys.BACK -> {
                ...
                else stageUI.root.animHide(Timek) { game.navigationManager.back() }
            }
        }
        return true
    }
