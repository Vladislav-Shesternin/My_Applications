package com.centurygames.idlecourie.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.CHEKEBOKSE -> Static.ACheckBoxStyle(
            default = screen.game.valhalla.qwsd,
            checked = screen.game.valhalla.cvbn,
        )
    }
