package com.picadilla.beepbeepvroo.game.actors.button
...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.MNU -> Static.AButtonStyle(
        ...
        Static.Type.Rght -> Static.AButtonStyle(
        ...
        Static.Type.Lfth -> Static.AButtonStyle(
