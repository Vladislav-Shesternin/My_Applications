package com.tutotoons.app.kpopsiescuteunicornpet.game.utils.advanced
...
import com.tutotoons.app.kpopsiescuteunicornpet.game.utils.SizeStandardizer
import com.tutotoons.app.kpopsiescuteunicornpet.game.utils.actor.setFillParent
import com.tutotoons.app.kpopsiescuteunicornpet.game.utils.advanced.AdvancedGroup.Static.AlignmentHorizontal
import com.tutotoons.app.kpopsiescuteunicornpet.game.utils.advanced.AdvancedGroup.Static.AlignmentVertical
...
import com.tutotoons.app.kpopsiescuteunicornpet.util.cancelCoroutinesAll
...
abstract class AdvancedGroup : WidgetGroup(), Disposable {
    ...
    fun addAndFillActors(actors: List<Actor>) {
        actors.forEach { addActor(it.apply { setSize(width, height) }) }
    }
