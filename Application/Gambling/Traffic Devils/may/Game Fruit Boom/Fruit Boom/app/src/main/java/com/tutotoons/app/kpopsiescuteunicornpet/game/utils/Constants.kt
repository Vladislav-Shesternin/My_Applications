package com.tutotoons.app.kpopsiescuteunicornpet.game.utils

import com.badlogic.gdx.math.Vector2
import kotlin.math.PI

const val WIDTH_UI     = 1605f
const val HEIGHT_UI    = 946f
const val WIDTH_BOX2D  = 10f
const val HEIGHT_BOX2D = 5.8940f
...
const val TIME_ANIM_SCREEN_ALPHA = 0.277f