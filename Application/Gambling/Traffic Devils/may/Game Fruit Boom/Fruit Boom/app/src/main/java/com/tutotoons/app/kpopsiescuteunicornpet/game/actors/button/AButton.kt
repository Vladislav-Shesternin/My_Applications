...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Def -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.btn_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.btn_prs),
            disabled = TextureRegionDrawable(screen.game.assetsAll.btn_dis),
        )
        Static.Type.Back -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.back_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.back_prs),
            disabled = TextureRegionDrawable(screen.game.assetsAll.back_def),
        )
        Static.Type.Quit -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.quit_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.quit_prs),
            disabled = TextureRegionDrawable(screen.game.assetsAll.quit_prs),
        )
        Static.Type.Go -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.go_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.go_prs),
            disabled = TextureRegionDrawable(screen.game.assetsAll.go_prs),
        )
        Static.Type.SUPER_GAME -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.super_game_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.super_game_press),
            disabled = TextureRegionDrawable(screen.game.assetsAll.super_game_press),
        )
        Static.Type.BIG_GAME -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.big_game_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.big_game_press),
            disabled = TextureRegionDrawable(screen.game.assetsAll.big_game_press),
        )
    }
    ...
    object Static {
        ...
        enum class Type {
            Quit, Back, Go, Def, SUPER_GAME, BIG_GAME
        }
    }
