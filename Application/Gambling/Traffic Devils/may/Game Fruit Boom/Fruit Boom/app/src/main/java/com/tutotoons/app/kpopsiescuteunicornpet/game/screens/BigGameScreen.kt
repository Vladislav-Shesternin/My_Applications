...
class BigGameScreen(override val game: GDXGame): AdvancedUserScreen() {
    ...
    private val randomItemSize get() = (190..290).random().toFloat()
    private val randomItemX    get() = (155..1310).random().toFloat()
    ...
    private fun createB_ItemList() {
        bItemList.onEach { bItem ->
            ...
            bItem.boomBlock = {
                fruitRecordFlow.value += (20..100).random()
            }
        }
