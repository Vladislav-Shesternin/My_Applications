package com.rusya.cartycoo.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Posrate -> Static.ACheckBoxStyle(
            default = screen.game.faradeo.cb_def,
            checked = screen.game.faradeo.cb_press,
        )
    }
