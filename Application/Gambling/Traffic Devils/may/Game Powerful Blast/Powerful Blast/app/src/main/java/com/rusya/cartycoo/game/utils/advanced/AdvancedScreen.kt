package com.rusya.cartycoo.game.utils.advanced
...
import com.rusya.cartycoo.game.utils.HEIGHT_UI
import com.rusya.cartycoo.game.utils.ShapeDrawerUtil
import com.rusya.cartycoo.game.utils.Poshlo_VREMA
import com.rusya.cartycoo.game.utils.WIDTH_UI
import com.rusya.cartycoo.game.utils.actor.animHide
import com.rusya.cartycoo.game.utils.addProcessors
import com.rusya.cartycoo.game.utils.disposeAll
import com.rusya.cartycoo.game.utils.font.FontGenerator
import com.rusya.cartycoo.util.cancelCoroutinesAll
...
abstract class AdvancedScreen(
    ...
    val fontGenerator_LeagueGothic = FontGenerator(FontGenerator.Companion.FontPath.LeagueGothic)
    ...
    override fun keyDown(keycode: Int): Boolean {
        when(keycode) {
            Input.Keys.BACK -> {
                ...
                else stageUI.root.animHide(Poshlo_VREMA) { game.navigationManager.back() }
            }
        }
        return true
    }
