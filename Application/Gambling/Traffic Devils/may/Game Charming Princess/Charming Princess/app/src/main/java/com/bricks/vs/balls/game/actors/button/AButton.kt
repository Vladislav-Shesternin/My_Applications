...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        ...
        Static.Type.Record -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.record_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.record_press),
            disabled = TextureRegionDrawable(screen.game.assetsAll.record_press),
        )
        Static.Type.LVL -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.lvl_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.lvl_press),
            disabled = TextureRegionDrawable(screen.game.assetsAll.lvl_dis),
        )
        Static.Type.FastGame -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.fg_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.fg_press),
            disabled = TextureRegionDrawable(screen.game.assetsAll.fg_press),
        )
        Static.Type.BigBall -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.assetsAll.bb_def),
            pressed = TextureRegionDrawable(screen.game.assetsAll.bb_press),
            disabled = TextureRegionDrawable(screen.game.assetsAll.bb_press),
        )
    }
    ...
    object Static {
        ...
        enum class Type {
            Exit, Back, Record, LVL, FastGame, BigBall
        }
    }
