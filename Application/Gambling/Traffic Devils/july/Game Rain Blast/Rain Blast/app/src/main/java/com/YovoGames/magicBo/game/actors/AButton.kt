package com.YovoGames.magicBo.game.actors
...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Back -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.jakarta.pkt),
            pressed = TextureRegionDrawable(screen.game.jakarta.brp),
            disabled = TextureRegionDrawable(screen.game.jakarta.brp),
        )
    }
