...
import com.bitmango.go.game.manager.MusicManager
    ...
    private fun loadSplashAssets() {
        with(game.spriteManager) {
            loadableTexturesList = mutableListOf(
                SpriteManager.EnumTexture.g1.data,
                SpriteManager.EnumTexture.g2.data,
                SpriteManager.EnumTexture.g3.data,
            )
            loadTexture()
        }
...
//                    if (progress % 85 == 0) log("progress = $progress%")
    ...
    private fun isFinish() {
        if (isFinishProgress) {
            ...
            game.musicUtil.apply { music = yellow.apply {
                isLooping = true
            ...
            stageUI.root.animHide(TIME_ANIM) {
                ...
                val screenName = if (game.prefsDialog.contains("IZmaIl")) MenuScreen::class.java.name else JorgScreen::class.java.name
