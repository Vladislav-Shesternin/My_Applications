package com.bitmango.go.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.MUS -> Static.ACheckBoxStyle(
            default = screen.game.bbb.qwe3,
            checked = screen.game.bbb.tghy,
        )
        Static.Type.SOD -> Static.ACheckBoxStyle(
            default = screen.game.bbb.ffggs,
            checked = screen.game.bbb.vcbxf,
        )
        Static.Type.PAUSE -> Static.ACheckBoxStyle(
            default = screen.game.bbb.tty5,
            checked = screen.game.bbb.vcxzd,
        )
    }
