package com.centurygames.idlecouri.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.ONOF -> Static.ACheckBoxStyle(
            default = screen.game.alpha.on,
            checked = screen.game.alpha.off,
        )
    }
