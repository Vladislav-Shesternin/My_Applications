...
class WorldUtil: Disposable {
    ...
    val bodyEditor    by lazy { BodyEditorLoader(Gdx.files.internal("physical/PhysicsData.json")) }

    val contactFilter   = WorldContactFilter()
    val contactListener = com.my.cooking.chef.kitchen.craze.fe.game.box2d.WorldContactListener()
