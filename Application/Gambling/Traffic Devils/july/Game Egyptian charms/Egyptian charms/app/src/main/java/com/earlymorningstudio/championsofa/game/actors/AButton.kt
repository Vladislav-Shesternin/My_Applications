package com.earlymorningstudio.championsofa.game.actors
...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Back -> Static.AButtonStyle(
            default = TextureRegionDrawable(screen.game.LICHIKO.asd11),
            pressed = TextureRegionDrawable(screen.game.LICHIKO.erad),
            disabled = TextureRegionDrawable(screen.game.LICHIKO.erad),
        )
    }
