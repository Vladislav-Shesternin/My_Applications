package com.earlymorningstudio.championsofa.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.Musicm -> Static.ACheckBoxStyle(
            default = screen.game.LICHIKO.iuil,
            checked = screen.game.LICHIKO.ioy,
        )
        Static.Type.Sound -> Static.ACheckBoxStyle(
            default = screen.game.LICHIKO.trytry,
            checked = screen.game.LICHIKO.bedty,
        )
    }
