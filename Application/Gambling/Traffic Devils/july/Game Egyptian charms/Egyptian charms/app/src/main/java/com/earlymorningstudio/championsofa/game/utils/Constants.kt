package com.earlymorningstudio.championsofa.game.utils

import com.badlogic.gdx.math.Vector2
import kotlin.math.PI

const val WIDTH_UI     = 1521f
const val HEIGHT_UI    = 900f
const val WIDTH_BOX2D  = 24f
const val HEIGHT_BOX2D = 14.2011f
