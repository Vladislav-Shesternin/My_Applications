package crapto.quantem.ao.webView
...
import crapto.quantem.ao.databinding.FragmentWebviewBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        webView = binding.webView.apply {
           ...
           // setDownloadListener(getDownloadListener())
            crapto.quantem.ao.MainActivity.lottie.hideLoader()
            loadUrl(crapto.quantem.ao.MainActivity.webViewURL)
