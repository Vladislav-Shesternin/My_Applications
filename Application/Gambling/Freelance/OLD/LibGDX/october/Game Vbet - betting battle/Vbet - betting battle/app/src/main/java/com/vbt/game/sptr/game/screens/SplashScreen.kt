...
import com.vbt.game.sptr.game.game
import com.vbt.game.sptr.game.manager.FontTTFManager
...
import com.vbt.game.sptr.game.util.Layout.Splash as LS

@SuppressLint("CustomSplashScreen")
class SplashScreen : AdvancedScreen() {

    private val progressLabel by lazy { Label("0", LabelStyle.aBeeZeeWhite_60) }
    ...
    private fun loadSplashAssets() {
        ...
        with(FontTTFManager) {
            loadableListFont = mutableListOf(FontTTFManager.ABeeZeeFont.font_60)
            load(game.assetManager)
        }
