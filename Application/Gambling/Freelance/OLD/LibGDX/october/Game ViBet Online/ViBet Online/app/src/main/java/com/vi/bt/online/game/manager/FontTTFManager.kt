...
object FontTTFManager {
    ...
    private const val pathABeeZee = "TTF/Alata.ttf"
...
//    }
    ...
    object AlataFont: IFont {
        override val font_70 = FontTTFData("Alata_70", getLoaderParameter(pathABeeZee) { size = 70 })
    }
    ...
    interface IFont {
        ...
        val values get() = listOf<FontTTFData>(font_70)
    }
