...
object FontTTFManager {
    ...
    private const val pathAmaticSC_Bold = "TTF/AmaticSC-Bold.ttf"
...
//    }
    ...
    object Amatic : IFont {
        val font_80 = FontTTFData("AmaticSC_Bold_80", getLoaderParameter(pathAmaticSC_Bold) { size = 80 })
        val font_50 = FontTTFData("AmaticSC_Bold_50", getLoaderParameter(pathAmaticSC_Bold) { size = 50 })
        val font_40 = FontTTFData("AmaticSC_Bold_40", getLoaderParameter(pathAmaticSC_Bold) { size = 40 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_80, font_50, font_40)
    }
