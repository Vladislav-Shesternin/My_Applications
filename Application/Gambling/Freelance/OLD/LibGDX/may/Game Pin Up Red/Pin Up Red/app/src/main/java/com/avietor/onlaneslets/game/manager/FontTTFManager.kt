...
object FontTTFManager {
    ...
    private const val pathABeeZeeRegular = "TTF/ABeeZee-Regular.ttf"
...
//    }
    ...
    object RegularFont: IFont {
        val font_90 = FontTTFData("Regular_90", getLoaderParameter(pathABeeZeeRegular) { size = 90 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_90)
    }
