...
class D11Screen(val activity: FragmentActivity) : DetailScreen(activity, R.drawable.i11) {

    private val imgs = ImageView(activity).apply { setImageResource(R.drawable.d11_tarantul) }

    override fun ViewGroup.addActorsOnStageDetail() {
        addView(imgs)
        sizeConverter.setBounds(imgs, 36f, 415f, 733f, 1252f)
    }
