...
class D6Screen(val activity: FragmentActivity) : DetailScreen(activity, R.drawable.i6) {

    private val imgs = ImageView(activity).apply { setImageResource(R.drawable.d6_panella) }

    override fun ViewGroup.addActorsOnStageDetail() {
        addView(imgs)
        sizeConverter.setBounds(imgs, 0f, 519f, 805f, 1137f)
    }
