...
//    }
    ...
    object Inter {
        object RegularFont : IFont {
            val font_63 = FontTTFData("Inter-Regular_63", getLoaderParameter(pathInter_Regular) { size = 63 })
            val font_30 = FontTTFData("Inter-Regular_30", getLoaderParameter(pathInter_Regular) { size = 30 })

            override val values: List<FontTTFData>
                get() = super.values + listOf(font_63, font_30)
        }
    }
