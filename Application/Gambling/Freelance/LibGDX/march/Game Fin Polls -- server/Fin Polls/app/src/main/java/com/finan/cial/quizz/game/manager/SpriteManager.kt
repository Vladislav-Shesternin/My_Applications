...
import com.finan.cial.quizz.game.utils.region
...
object SpriteManager {
    ...
    enum class EnumTexture(override val data: TextureData): ITexture {
        BAC(TextureData("textures/bac.png")),
        MON(TextureData("textures/mon.png")),
    }



    enum class SplashRegion(override val region: TextureRegion): IRegion {
        BAC(EnumTexture.BAC.data.texture.region),
    }

    enum class GameRegion(override val region: TextureRegion): IRegion {
        ANS(EnumAtlas.GAME.data.atlas.findRegion("ans")),
        BTN(EnumAtlas.GAME.data.atlas.findRegion("btn")),
        MTN(EnumAtlas.GAME.data.atlas.findRegion("mtn")),
        PNL(EnumAtlas.GAME.data.atlas.findRegion("pnl")),

        MON(EnumTexture.MON.data.texture.region),
    }
