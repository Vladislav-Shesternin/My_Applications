...
object FontTTFManager {
    ...
    private const val pathJura_Bold = "TTF/Jura-Bold.ttf"
...
//    }
    ...
    object Jura : IFont {
        val font_78 = FontTTFData("Jura_Bold_78", getLoaderParameter(pathJura_Bold) { size = 78 })
        val font_60 = FontTTFData("Jura_Bold_60", getLoaderParameter(pathJura_Bold) { size = 60 })
        val font_50 = FontTTFData("Jura_Bold_50", getLoaderParameter(pathJura_Bold) { size = 50 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_78, font_60, font_50)
    }
