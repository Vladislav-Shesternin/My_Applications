...
object FontTTFManager {
    ...
    private const val pathIndieFlowerRegular = "TTF/IndieFlower-Regular.ttf"
...
//    }
    ...
    object Indie: IFont {
        val font_120 = FontTTFData("Indie 120", getLoaderParameter(pathIndieFlowerRegular) { size = 120 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_120)
    }
