...
object FontTTFManager {
    ...
    private const val pathLindenHillRegular = "TTF/LindenHillRegular.ttf"
...
//    }
    ...
    object Money: IFont {
        val font_55 = FontTTFData("Money_55", getLoaderParameter(pathLindenHillRegular) { size = 55 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_55)
    }
