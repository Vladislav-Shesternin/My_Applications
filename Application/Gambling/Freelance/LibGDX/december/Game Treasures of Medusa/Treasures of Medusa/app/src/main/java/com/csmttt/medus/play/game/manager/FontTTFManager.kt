...
//    }
    ...
    object Font: IFont {
        override val font_141 = FontTTFData("Font_141", getLoaderParameter(pathFont) { size = 141 })
        override val font_38 = FontTTFData("Font_38", getLoaderParameter(pathFont) { size = 38 })
    }



    interface IFont {
        val font_141: FontTTFData
        val font_38: FontTTFData

        val values get() = listOf<FontTTFData>(font_141, font_38)
    }
