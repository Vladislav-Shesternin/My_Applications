...
object FontTTFManager {
    ...
    private const val pathOpenSansBold = "TTF/OpenSansBold.ttf"
...
//    }
    ...
    object OpenSansBold: IFont {
        override val font_77 = FontTTFData("OpenSansBold_77", getLoaderParameter(pathOpenSansBold) { size = 77 })
    }



    interface IFont {
        val font_77: FontTTFData

        val values get() = listOf<FontTTFData>(font_77)
    }
