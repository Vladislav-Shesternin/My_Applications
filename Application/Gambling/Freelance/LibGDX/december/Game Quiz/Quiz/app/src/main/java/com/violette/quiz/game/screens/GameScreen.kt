...
import com.violette.quiz.game.actors.checkbox.CheckBoxGroup
import com.violette.quiz.game.actors.checkbox.CheckBoxStyle
import com.violette.quiz.game.actors.label.LabelStyle
import com.violette.quiz.game.actors.label.spinning.SpinningLabel
import com.violette.quiz.game.manager.NavigationManager
import com.violette.quiz.game.manager.SpriteManager
import com.violette.quiz.game.util.Layout
import com.violette.quiz.game.util.advanced.AdvancedScreen
import com.violette.quiz.game.util.advanced.AdvancedStage
import com.violette.quiz.game.util.disable
import com.violette.quiz.game.util.Layout.Game as LG
...
class GameScreen: AdvancedScreen() {
    ...
    private val cbList = List(2) { com.violette.quiz.game.actors.checkbox.CheckBox(CheckBoxStyle.cb).apply { checkBoxGroup = checkGroup } }
    private val answer = List(2) { Image(SpriteManager.GameRegion.ANS_DEF.region) }
    private val answerText = List(2) { SpinningLabel("", LabelStyle.aleoWhite_50).apply { disable() } }
