...
object FontTTFManager {
    ...
    private const val pathRoboto = "TTF/Halogen.ttf"
...
//    }
    ...
    object SemiBold: IFont {
        val font_72 = FontTTFData("HindKochi_SemiBold 72", getLoaderParameter(pathRoboto) { size = 72 })
        val font_50 = FontTTFData("HindKochi_SemiBold 50", getLoaderParameter(pathRoboto) { size = 50 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_72, font_50)
    }
