...
class BEnemyTry(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {

    override var id         = ENEMY
    override val name       = "enemy_try"
    override val bodyDef    = BodyDef().apply {
        type = BodyDef.BodyType.StaticBody
    }
    override val fixtureDef = FixtureDef()
    override val collisionList: MutableList<BodyId> = mutableListOf(BALL)
    override val actor = AImage(SpriteManager.GameRegion.ENEMY_TRY.region)
}