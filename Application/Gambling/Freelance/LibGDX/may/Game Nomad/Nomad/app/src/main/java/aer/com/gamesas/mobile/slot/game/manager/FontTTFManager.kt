...
object FontTTFManager {
    ...
    private const val pathInterRegular = "TTF/Inter-Regular.ttf"
...
//    }
    ...
    object RegularFont: IFont {
        val font_20 = FontTTFData("Regular_20", getLoaderParameter(pathInterRegular) { size = 20 })
        val font_50 = FontTTFData("Regular_50", getLoaderParameter(pathInterRegular) { size = 50 })
        val font_75 = FontTTFData("Regular_75", getLoaderParameter(pathInterRegular) { size = 75 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_20, font_50, font_75)
    }
