...
import aer.com.gamesas.mobile.slot.game.utils.addProcessors
import aer.com.gamesas.mobile.slot.game.utils.disposeAll
import aer.com.gamesas.mobile.slot.util.cancelCoroutinesAll
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers


abstract class AdvancedScreen(
    val WIDTH : Float = 708f,
    val HEIGHT: Float = 1540f
