...
object FontTTFManager {
    ...
    private const val pathInriaSerifRegular = "TTF/InriaSerif-Regular.ttf"
...
//    }
    ...
    object InriaSerifFont: IFont {
        val font_68 = FontTTFData("InriaSerif-Regular 68", getLoaderParameter(pathInriaSerifRegular) { size = 68 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_68)
    }
