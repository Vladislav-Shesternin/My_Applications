package italodisco.fernando.fin
...
import italodisco.fernando.fin.util.webView.WebViewFragment
...
import italodisco.fernando.fin.databinding.ActivityMainBinding
import italodisco.fernando.fin.util.Lottie
import italodisco.fernando.fin.util.Once
import italodisco.fernando.fin.util.internetConnection
import italodisco.fernando.fin.util.log
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    companion object {
        ...
        val startViewId = MutableSharedFlow<Int>(replay = 1, onBufferOverflow = BufferOverflow.DROP_OLDEST)
        var webURL      = "https://pin-up.ua"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (internetConnection().not()) lottie.showNotInternet()
            ...
            coroutine.launch(Dispatchers.IO) {
                ...
                startViewId.tryEmit(WEB_ID)

                launch(Dispatchers.Main) {
                    startViewId.collect { fragmentId ->
                        when (fragmentId) {
                            WEB_ID -> {
    ...
    private fun initialize() {
        ...
        webViewFragment.onCreate(coroutine, binding.werdeGarden)
    }
