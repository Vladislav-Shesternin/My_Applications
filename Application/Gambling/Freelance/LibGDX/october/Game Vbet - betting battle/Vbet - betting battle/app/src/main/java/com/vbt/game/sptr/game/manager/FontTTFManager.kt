package com.vbt.game.sptr.game.manager
...
object FontTTFManager {
    ...
    private const val pathABeeZee = "TTF/ABeeZee.ttf"
...
//    }
    ...
    object ABeeZeeFont: IFont {
        override val font_60 = FontTTFData("ABeeZee_60", getLoaderParameter(pathABeeZee) { size = 60 })
    }
    ...
    interface IFont {
        ...
        val values get() = listOf<FontTTFData>(font_60)
    }
