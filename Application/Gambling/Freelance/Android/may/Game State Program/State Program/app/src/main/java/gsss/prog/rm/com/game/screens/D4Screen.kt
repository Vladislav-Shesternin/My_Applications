...
class D4Screen(val activity: FragmentActivity) : DetailScreen(activity, R.drawable.i4) {

    private val imgs = ImageView(activity).apply { setImageResource(R.drawable.d4_panella) }

    override fun ViewGroup.addActorsOnStageDetail() {
        addView(imgs)
        sizeConverter.setBounds(imgs, 28f, 507f, 748f, 1144f)
    }
