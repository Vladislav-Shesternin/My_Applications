...
class D1Screen(val activity: FragmentActivity) : DetailScreen(activity, R.drawable.i1) {

    private val imgs = ImageView(activity).apply { setImageResource(R.drawable.d11111) }

    override fun ViewGroup.addActorsOnStageDetail() {
        addView(imgs)
        sizeConverter.setBounds(imgs, 28f, 436f, 749f, 780f)
    }
