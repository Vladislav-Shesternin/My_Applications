...
import com.slotscity.official.game.utils.Layout.SlotGroup as LSG
...
class SlotGroup(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val mask       = Mask(screen, screen.game.allAssets.slot_group_mask, alphaHeight = 500)
    ...
    private val slotItemContainer = SlotItemContainer(screen.game.allAssets.listItem)
