...
import com.slotscity.official.game.utils.Layout.TreasureSnipes.SlotGroup as LSG
...
class SlotGroup(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val mask       = Mask(screen, screen.game.treasureSnipesAssets.SLOT_MASK, alphaHeight = 1000)
    ...
    private val slotItemContainer = SlotItemContainer(screen.game.treasureSnipesAssets.listItem)
