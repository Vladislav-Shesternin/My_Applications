...
//
//    private val backgroundImage = Image(screen.game.alllAssets.panal)
//    private val progressImage   = Image(screen.game.alllAssets.timi_terner)
//    private val mask            = Mask(screen, screen.game.alllAssets.TIMR_MASKR, alphaWidth = 1000)
//    private val timerImage      = Image(screen.game.alllAssets.tim_ic)
//
//    var isPause = false
//
