...
import com.jettylucketjet1wincasino.onewinslots1win.util.Lottie
import com.jettylucketjet1wincasino.onewinslots1win.util.cancelCoroutinesAll
import com.jettylucketjet1wincasino.onewinslots1win.util.log
import com.jettylucketjet1wincasino.onewinslots1win.util.network.NetworkUtil
import com.jettylucketjet1wincasino.onewinslots1win.util.network.haveNetworkConnection
import com.jettylucketjet1wincasino.onewinslots1win.webView.webViewFragment
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.channels.BufferOverflow
import kotlinx.coroutines.flow.MutableSharedFlow
import kotlinx.coroutines.launch
import com.jettylucketjet1wincasino.onewinslots1win.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    companion object {
        ...
        private const val REQUEST = "https://rockettapapp.com/game_android.php?a=30"
    }
...
//                            }
    ...
    private suspend fun getRemoteData() {
        NetworkUtil.service.getJsonByUrl(REQUEST + "&" + "lang=${Locale.getDefault()}").body()?.string()?.let { response ->
            try {
