...
import com.farello.rocketing.game.utils.region
import com.farello.rocketing.util.log
import kotlinx.coroutines.delay
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.launch

class FarelloLoaderScreen(override val game: LibGDXGame) : AdvancedScreen() {
    ...
    private fun isFinish() {
        if (isFinishProgress) {
            ...
            stageUI.root.animHide(TIME_ANIM) {
                game.navigationManager.navigate(FarelloGameScreen::class.java.name)
            }
        }
    }
