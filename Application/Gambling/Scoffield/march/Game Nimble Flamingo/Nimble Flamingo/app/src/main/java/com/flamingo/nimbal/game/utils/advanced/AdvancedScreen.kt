package com.flamingo.nimbal.game.utils.advanced
...
import com.flamingo.nimbal.game.actors.ABackground
import com.flamingo.nimbal.game.utils.HEIGHT_UI
import com.flamingo.nimbal.game.utils.ShapeDrawerUtil
...
import com.flamingo.nimbal.game.utils.addProcessors
import com.flamingo.nimbal.game.utils.disposeAll
import com.flamingo.nimbal.game.utils.font.FontGenerator
import com.flamingo.nimbal.game.utils.font.FontGenerator.Companion.FontPath
import com.flamingo.nimbal.util.cancelCoroutinesAll
import com.flamingo.nimbal.util.log
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers

var isMoveBackckground = false
...
abstract class AdvancedScreen(
    ...
    val fontGenerator_MetamorphousRegular = FontGenerator(FontPath.MetamorphousRegular)
    ...
    override fun show() {
        if (isMoveBackckground) {
            stageBack.addAndFillActor(ABackground(this))
        } else stageBack.addAndFillActor(backBackgroundImage)
    ...
    override fun dispose() {
        ...
        disposeAll(
            ...
            fontGenerator_MetamorphousRegular,
        )
