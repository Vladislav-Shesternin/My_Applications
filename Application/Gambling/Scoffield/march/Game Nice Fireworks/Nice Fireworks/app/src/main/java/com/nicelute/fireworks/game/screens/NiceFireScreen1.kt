...
class NiceFireScreen1(override val game: LibGDXGame) : AdvancedScreen() {

    private val particle1 = ParticleEffectActor(game.particleEffectUtil.F1_SALUT_1, true)
    private val particle2 = ParticleEffectActor(game.particleEffectUtil.F1_SALUT_2, true)

    private val btn = Image(game.allAssets.btn)

    override fun show() {
        setBackBackground(game.allAssets.backs[0].region)
        super.show()
    }
