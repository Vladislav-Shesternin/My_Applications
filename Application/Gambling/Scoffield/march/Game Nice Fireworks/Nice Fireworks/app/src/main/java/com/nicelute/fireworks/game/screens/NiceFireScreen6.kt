...
class NiceFireScreen6(override val game: LibGDXGame) : AdvancedScreen() {

    private val particle1 = ParticleEffectActor(game.particleEffectUtil.F6_SALUT_1, true)
    private val particle2 = ParticleEffectActor(game.particleEffectUtil.F6_SALUT_2, true)

    private val btn = Image(game.allAssets.btn)

    override fun show() {
        setBackBackground(game.allAssets.backs[5].region)
        super.show()
    }
        ...
        play.setOnClickListener(game.soundUtil) {
            ...
            particle1.apply {
                ...
                addAction(Actions.sequence(
                    Actions.moveTo(540f, 1342f, 3.2f, Interpolation.swing),
                    Actions.run {
