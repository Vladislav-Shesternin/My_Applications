...
class NiceFireScreen3(override val game: LibGDXGame) : AdvancedScreen() {

    private val particle1 = ParticleEffectActor(game.particleEffectUtil.F3_SALUT_1, true)
    ...
    override fun show() {
        setBackBackground(game.allAssets.backs[2].region)
        super.show()
    }
        ...
        play.setOnClickListener(game.soundUtil) {
            ...
            particle1.apply {
                ...
                addAction(Actions.sequence(
                    Actions.moveTo(540f, 1342f, 3f, Interpolation.smoother),
                    Actions.run {
