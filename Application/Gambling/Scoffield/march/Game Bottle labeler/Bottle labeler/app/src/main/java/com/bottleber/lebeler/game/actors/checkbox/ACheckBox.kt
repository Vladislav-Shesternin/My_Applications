package com.bottleber.lebeler.game.actors.checkbox
...
import com.bottleber.lebeler.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.SHOT    -> Static.ACheckBoxStyle(
            default = TextureEmpty.region,
            checked = screen.game.allAssets.precel,
        )
    }
