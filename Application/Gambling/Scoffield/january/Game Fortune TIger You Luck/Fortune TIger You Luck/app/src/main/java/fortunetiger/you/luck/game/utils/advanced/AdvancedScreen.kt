package fortunetiger.you.luck.game.utils.advanced
...
import fortunetiger.you.luck.game.utils.HEIGHT_UI
import fortunetiger.you.luck.game.utils.ShapeDrawerUtil
import fortunetiger.you.luck.game.utils.TIME_ANIM_SCREEN_ALPHA
import fortunetiger.you.luck.game.utils.WIDTH_UI
import fortunetiger.you.luck.game.utils.actor.animHide
import fortunetiger.you.luck.game.utils.addProcessors
import fortunetiger.you.luck.game.utils.disposeAll
import fortunetiger.you.luck.game.utils.font.FontGenerator
import fortunetiger.you.luck.game.utils.font.FontGenerator.Companion.FontPath
...
abstract class AdvancedScreen(
    ...
    val fontGeneratorLionKing = FontGenerator(FontPath.LionKing)
    ...
    private fun animShowScreen() {
        stageUI.root.addAction(Actions.moveTo(0f, 0f, TIME_ANIM_SCREEN_ALPHA, Interpolation.sineOut))
    }

    fun animHideScreen(block: () -> Unit = {}) {
        stageUI.root.addAction(Actions.sequence(
            Actions.moveTo(WIDTH, 0f, TIME_ANIM_SCREEN_ALPHA, Interpolation.sineIn),
            Actions.run(block),
        ))
    }
