...
class LoaMenuScreen(override val game: LibGDXGame) : AdvancedScreen() {
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        coroutine?.launch {
            ...
            delay(100)
            menuImg.animShow_Suspend(com.sca.rab.que.stgame.game.utils.TIME_ANIM_SCREEN_ALPHA)
        }
    }
    ...
    private fun AdvancedStage.addMenu() {
        ...
        val selections = listOf(
            ...
            com.sca.rab.que.stgame.game.screens.LoaSettingsScreen::class.java.name,
        )
