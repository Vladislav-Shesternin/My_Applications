...
class AMusicSound(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val mask          = Mask(screen, screen.game.gameAssets.VOLUME_MASK, alphaWidth = 1000)
    private val progressImage = Image(screen.game.gameAssets.volume_progress)
    private val cursorImage   = Image(screen.game.gameAssets.lapa)
