...
import com.sca.rab.que.stgame.game.utils.TIME_ANIM_SCREEN_ALPHA
...
abstract class AdvancedScreen(
    ...
    override fun show() {
        game.activity.webViewFragment.backBlock = { runGDX { stageUI.root.animHide(
            TIME_ANIM_SCREEN_ALPHA
