package jogos.tigerfortune.tighrino.game.actors.checkbox
...
import jogos.tigerfortune.tighrino.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.MUSIC -> Static.ACheckBoxStyle(
            default = assets.mus_def,
            checked = assets.mus_check,
        )
