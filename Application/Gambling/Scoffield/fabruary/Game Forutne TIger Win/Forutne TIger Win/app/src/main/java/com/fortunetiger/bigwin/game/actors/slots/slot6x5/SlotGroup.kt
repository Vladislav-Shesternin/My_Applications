...
import com.fortunetiger.bigwin.game.actors.slots.FillStrategy
...
import com.fortunetiger.bigwin.game.utils.Layout.SlotGroup as LSG
...
class SlotGroup(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val slotItemContainer = SlotItemContainer(screen.game.allAssets.listItems)
