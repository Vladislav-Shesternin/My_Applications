...
object FontTTFManager {
    ...
    private const val pathAladinRegular = "font/Aladin-Regular.ttf"
...
//    }
    ...
    object AladinFont: IFont {
        override val font_45 = FontTTFData("Aladin_45", getLoaderParameter(pathAladinRegular) { size = 45 })
        override val font_100 = FontTTFData("Aladin_100", getLoaderParameter(pathAladinRegular) { size = 100 })
    }



    interface IFont {
        val font_45: FontTTFData
        val font_100: FontTTFData

        val values get() = listOf<FontTTFData>(font_45, font_100)
    }
