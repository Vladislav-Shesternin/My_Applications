...
object FontTTFManager {
    ...
    private const val pathAkshar = "TTF/Akshar.ttf"
...
//    }
    ...
    object AksharFont: IFont {
        override val font_25 = FontTTFData("Akshar_25", getLoaderParameter(pathAkshar) { size = 25 })
    }
    ...
    interface IFont {
        ...
        val values get() = listOf<FontTTFData>(font_25)
    }
