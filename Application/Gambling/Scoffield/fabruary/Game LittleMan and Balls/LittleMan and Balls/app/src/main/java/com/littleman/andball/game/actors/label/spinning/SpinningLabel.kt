package com.littleman.andball.game.actors.label.spinning
...
import com.littleman.andball.game.actors.masks.normal.Mask
import com.littleman.andball.game.util.advanced.AdvancedGroup
import com.littleman.andball.util.toMS
...
class SpinningLabel(
    ...
    private var labelCurrent = Label(lText, labelStyle)
    private var labelNext    = Label(lText, labelStyle)
