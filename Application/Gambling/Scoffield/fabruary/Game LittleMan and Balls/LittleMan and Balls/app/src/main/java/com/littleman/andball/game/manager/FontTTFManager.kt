package com.littleman.andball.game.manager
...
object FontTTFManager {
    ...
    private const val pathFanta = "TTF/Fanta.ttf"
...
//    }
    ...
    object FantaFont: IFont {
        override val font_45 = FontTTFData("Fanta_45", getLoaderParameter(pathFanta) { size = 45 })
    }
    ...
    interface IFont {
        ...
        val values get() = listOf<FontTTFData>(font_45)
    }
