...
class BUserA(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {
    override val name       = "a"
    ...
    override var actor: AdvancedGroup? = AImage(screenBox2d, screenBox2d.game.allAssets.a_user)
