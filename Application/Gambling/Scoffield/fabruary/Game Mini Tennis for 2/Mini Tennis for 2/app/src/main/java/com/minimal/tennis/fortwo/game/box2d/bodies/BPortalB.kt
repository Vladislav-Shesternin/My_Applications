...
class BPortalB(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {
    ...
    override var actor: AdvancedGroup? = AImage(screenBox2d, screenBox2d.game.allAssets.portal_b)
