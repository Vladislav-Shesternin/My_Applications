...
class BUserB(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {
    override val name       = "b"
    ...
    override var actor: AdvancedGroup? = AImage(screenBox2d, screenBox2d.game.allAssets.b_user)
