package com.levitation.plates.game.box2d.bodiesGroup

import com.levitation.plates.game.box2d.AbstractBodyGroup
import com.levitation.plates.game.box2d.BodyId
import com.levitation.plates.game.box2d.bodies.BHorizontal
    ...
    private fun initB_Borders() {
        arrayOf(bTop, bDown, bLeft, bRight).onEach { it.apply {
            ...
            collisionList.addAll(arrayOf(
                BodyId.Cosmos.TARELKA,
                BodyId.Cosmos.PLANETA,
            ))
        } }
    }
