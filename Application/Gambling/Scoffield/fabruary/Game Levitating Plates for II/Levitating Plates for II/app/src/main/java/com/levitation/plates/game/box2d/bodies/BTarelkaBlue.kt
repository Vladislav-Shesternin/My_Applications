...
import com.levitation.plates.game.actors.ATarelkaBlue
...
class BTarelkaBlue(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {
    ...
    override var actor: AdvancedGroup? = ATarelkaBlue(screenBox2d)
