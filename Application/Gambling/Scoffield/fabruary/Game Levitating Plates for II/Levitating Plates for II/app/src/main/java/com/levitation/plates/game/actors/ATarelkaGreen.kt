...
class ATarelkaGreen(override val screen: AdvancedScreen): AdvancedGroup() {

    private val someImg   = Image(screen.game.allAssets.green_tarelka)
    private val circleImg = Image(screen.game.allAssets.green)
