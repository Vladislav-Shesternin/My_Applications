package lycky.fortune.tiger.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.SOUND -> Static.ACheckBoxStyle(
            default = assets.tiger_sound,
            checked = assets.tiger_sound_not,
        )
        Static.Type.PAUSE -> Static.ACheckBoxStyle(
            default = assets.tiger_pause_def,
            checked = assets.tiger_pause_dis,
        )
        Static.Type.CB -> Static.ACheckBoxStyle(
            default = assets.rectangle,
            checked = assets.rectangle_check,
        )
    }
