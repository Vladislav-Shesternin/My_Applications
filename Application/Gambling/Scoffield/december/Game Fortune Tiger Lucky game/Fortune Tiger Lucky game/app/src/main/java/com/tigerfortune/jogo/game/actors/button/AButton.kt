package com.tigerfortune.jogo.game.actors.button
...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        ...
        Static.Type.OK -> Static.AButtonStyle(
            default = assets.ok_def,
            pressed = assets.ok_press,
            disabled = assets.ok_press,
        )
    }
