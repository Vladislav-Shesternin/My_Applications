package iconic.duo.hunt.game.manager
...
object FontTTFManager {
    ...
    private const val pathKyivTypeTitling = "TTF/KyivTypeTitling.ttf"
...
//    }
    ...
    object RegularFont : IFont {
        val font_60 = FontTTFData("Regular_60", getLoaderParameter(pathKyivTypeTitling) { size = 60 })
        val font_300 = FontTTFData("Regular_300", getLoaderParameter(pathKyivTypeTitling) { size = 300 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_60, font_300)
    }
