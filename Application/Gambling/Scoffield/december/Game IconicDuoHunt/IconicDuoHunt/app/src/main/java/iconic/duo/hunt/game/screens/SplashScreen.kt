...
import iconic.duo.hunt.game.game
import iconic.duo.hunt.game.manager.FontTTFManager
...
import iconic.duo.hunt.game.utils.runGDX
import iconic.duo.hunt.util.log
...
class SplashScreen : AdvancedScreen() {
    ...
    private fun isFinish() {
        if (isFinishProgress && isFinishAnim) {
            ...
            iconic.duo.hunt.MainActivity.lottie.hideLoader()
