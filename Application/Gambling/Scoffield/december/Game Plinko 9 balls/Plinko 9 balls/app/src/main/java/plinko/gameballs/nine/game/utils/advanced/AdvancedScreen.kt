package plinko.gameballs.nine.game.utils.advanced
...
import plinko.gameballs.nine.game.utils.HEIGHT_UI
import plinko.gameballs.nine.game.utils.ShapeDrawerUtil
import plinko.gameballs.nine.game.utils.TIME_ANIM_SCREEN_ALPHA
import plinko.gameballs.nine.game.utils.WIDTH_UI
import plinko.gameballs.nine.game.utils.actor.animHide
import plinko.gameballs.nine.game.utils.addProcessors
import plinko.gameballs.nine.game.utils.disposeAll
import plinko.gameballs.nine.game.utils.font.FontGenerator
import plinko.gameballs.nine.game.utils.font.FontGenerator.Companion.FontPath
...
abstract class AdvancedScreen(
    ...
    val fontGeneratorInterBold = FontGenerator(FontPath.InterBold)
    val fontGeneratorInterSemiBold = FontGenerator(FontPath.InterSemiBold)
...
//        Gdx.input.setCatchKey(Input.Keys.BACK, true)
    ...
    override fun dispose() {
        ...
        disposeAll(
            ...
            fontGeneratorInterBold, fontGeneratorInterSemiBold
        )
