...
class SpriteManager(var assetManager: AssetManager) {
    ...
    enum class EnumTexture(val data: TextureData) {
        btnrs(TextureData("textures/btnrs.png")),
        flgs(TextureData("textures/flgs.png")),
        pole(TextureData("textures/pole.png")),
        btnrs_uk(TextureData("textures/btnrs_uk.png")),
        pisok(TextureData("textures/pisok.png")),
    }
