...
import rainbowriches.lucky.start.game.actors.panel.APanelLevels
...
class LevNorHardScreen(override val game: LibGDXGame) : AdvancedScreen() {
    ...
    private val panel   = APanelLevels(this).apply { color.a = 0f }
