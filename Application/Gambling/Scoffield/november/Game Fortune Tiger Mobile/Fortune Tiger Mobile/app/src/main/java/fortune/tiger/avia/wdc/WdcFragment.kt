package fortune.tiger.avia.wdc
...
class WdcFragment(private val activity: MainActivity) {
...
//                setSupportMultipleWindows(true)
            ...
            webChromeClient = WdcChromeClient(activity)
            webViewClient   = WdcClient(activity)
    ...
    fun showAndOpenUrl() {
        ...
        coroutine?.launch(Dispatchers.Main) {
            ...
            webView?.loadUrl(MainActivity.URL_Wdc)
        }
    }
