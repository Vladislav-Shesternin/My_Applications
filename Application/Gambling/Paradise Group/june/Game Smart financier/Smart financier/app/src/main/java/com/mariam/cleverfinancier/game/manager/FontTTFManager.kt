...
object FontTTFManager {
    ...
    private const val pathGilroyRegular   = "TTF/Gilroy-Regular.ttf"
...
//    }
    ...
    object Regular: IFont {
        val font_21 = FontTTFData("Regular_21", getLoaderParameter(pathGilroyRegular) { size = 21 })
        val font_33 = FontTTFData("Regular_33", getLoaderParameter(pathGilroyRegular) { size = 33 })
        val font_54 = FontTTFData("Regular_54", getLoaderParameter(pathGilroyRegular) { size = 54 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_21, font_33, font_54)
    }
    interface IFont {
