...
import com.mariam.cleverfinancier.game.manager.*
...
import com.mariam.cleverfinancier.util.log
    ...
    private fun isFinish() {
        if (isFinishProgress && isFinishAnim) {
            ...
            coroutine.launch(Dispatchers.IO) {
                ...
                runGDX {
                    MainActivity.lottie.hideLoader()
                    NavigationManager.navigate(if (isAgree) GlavniyScreen() else SamsaPrikaScreen())
                }
            }
        }
    }
