...
//    }
    ...
    object RegularraFont: IFont {
        val font_73  = FontTTFData("Regularro_73", getLoaderParameter(pathNunitoSans10ptRegular) { size = 73 })
        val font_50  = FontTTFData("Regularro_50", getLoaderParameter(pathNunitoSans10ptRegular) { size = 50 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_73, font_50)
    }
