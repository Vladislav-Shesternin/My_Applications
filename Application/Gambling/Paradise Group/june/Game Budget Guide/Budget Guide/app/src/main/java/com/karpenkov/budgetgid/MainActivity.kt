...
import com.karpenkov.budgetgid.databinding.ActivityMainBinding
import com.karpenkov.budgetgid.util.*
import com.karpenkov.budgetgid.util.network.internetConnection
import com.karpenkov.budgetgid.webView.webViewFragment
import com.karpenkov.budgetgid.util.manager.DataStoreManager
import com.karpenkov.budgetgid.util.network.NetworkUtil
        ...
        Firebase.remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener(this@MainActivity) { task ->
                if (task.isSuccessful) {
                    val jsonData = getString("jjsonDData")
