package com.shapovalovd.financecomitet.game.actors.masks.normal
...
import com.shapovalovd.financecomitet.game.utils.zeroScreenVector
...
class Mask(
    ...
    private fun updateCoordinatesAndSize() {
        ...
        mX = screenCoordinates.x + 1
        mY = Gdx.graphics.height - screenCoordinates.y + 1
