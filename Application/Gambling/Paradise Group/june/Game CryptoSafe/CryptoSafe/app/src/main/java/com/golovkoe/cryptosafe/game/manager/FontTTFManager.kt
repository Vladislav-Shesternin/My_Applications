package com.golovkoe.cryptosafe.game.manager
...
object FontTTFManager {
    ...
    private const val pathArchivoMedium  = "TTF/Archivo-Medium.ttf"
    private const val pathArchivoRegular = "TTF/Archivo-Regular.ttf"
...
//    }
    ...
    object Regular: IFont {
        val font_81 = FontTTFData("Reg_81", getLoaderParameter(pathArchivoRegular) { size = 81 })
        val font_31 = FontTTFData("Reg_31", getLoaderParameter(pathArchivoRegular) { size = 31 })
        val font_22 = FontTTFData("Reg_22", getLoaderParameter(pathArchivoRegular) { size = 22 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_81, font_31, font_22)
    }

    object Medium: IFont {
        val font_26 = FontTTFData("Med_26", getLoaderParameter(pathArchivoMedium) { size = 26 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_26)
    }
