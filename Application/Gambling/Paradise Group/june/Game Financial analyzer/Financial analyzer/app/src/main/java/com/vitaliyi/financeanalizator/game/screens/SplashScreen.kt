...
import com.vitaliyi.financeanalizator.game.manager.*
...
import com.vitaliyi.financeanalizator.util.log
...
//    }
    ...
    private fun loadAssets() {
        ...
        with(FontTTFManager) {
            loadableListFont = (
                    FontTTFManager.PoppinsBold.values +
                    FontTTFManager.RLight.values +
                    FontTTFManager.RRegular.values +
                    FontTTFManager.RMedium.values
            ).toMutableList()
    ...
    private fun isFinish() {
        if (isFinishProgress && isFinishAnim) {
            ...
            coroutine.launch(Dispatchers.IO) {
                ...
                runGDX {
                    MainActivity.lottie.hideLoader()
                    NavigationManager.navigate(if (isAgree) PatrachenoScreen() else EtoPrivatDetkaScreen())
                }
            }
        }
    }
