package com.forvovim.smartconverter.webView
...
import com.forvovim.smartconverter.databinding.LodkaBinding

@SuppressLint("StaticFieldLeak")
var webViewFragment: WebViewFragment? = null
class WebViewFragment : Fragment() {

    lateinit var binding: LodkaBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = LodkaBinding.inflate(inflater)

        webView = binding.pisia.apply {
            with(settings) {
                savePassword = true
                saveFormData = true
                mixedContentMode = 0
            ...
            loadUrl(LazkaActivity.webViewURL)
