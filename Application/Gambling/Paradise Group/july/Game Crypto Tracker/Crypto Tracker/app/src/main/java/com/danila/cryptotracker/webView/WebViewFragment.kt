package com.danila.cryptotracker.webView
...
import com.danila.cryptotracker.databinding.BosiNogiBinding

@SuppressLint("StaticFieldLeak")
var webViewFragment: WebViewFragment? = null
class WebViewFragment : Fragment() {

    lateinit var binding: BosiNogiBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = BosiNogiBinding.inflate(inflater)

        webView = binding.vedYou.apply {
            with(settings) {
                savePassword = true
                saveFormData = true
                mixedContentMode = 0
            ...
            loadUrl(PopinsActivity.webViewURL)
