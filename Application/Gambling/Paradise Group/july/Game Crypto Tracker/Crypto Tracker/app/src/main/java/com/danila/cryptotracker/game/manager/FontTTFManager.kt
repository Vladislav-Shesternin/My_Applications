...
//    }
    ...
    object GilBold: IFont {
        val font_55 = FontTTFData("GilBold_55", getLoaderParameter(pathGilroy_Bold) { size = 55 })
        val font_46 = FontTTFData("GilBold_46", getLoaderParameter(pathGilroy_Bold) { size = 46 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_55, font_46)
    }
