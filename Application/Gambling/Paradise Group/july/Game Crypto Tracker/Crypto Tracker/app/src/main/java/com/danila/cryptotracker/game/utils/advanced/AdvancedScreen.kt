package com.danila.cryptotracker.game.utils.advanced
...
import com.danila.cryptotracker.game.utils.addProcessors
import com.danila.cryptotracker.game.utils.disposeAll
import com.danila.cryptotracker.util.cancelCoroutinesAll
...
abstract class AdvancedScreen(
    ...
    override fun keyDown(keycode: Int): Boolean {
        if (keycode == Input.Keys.BACK) mainGroup.animAlpha0(0.4f) { NavigationManager.back() }
