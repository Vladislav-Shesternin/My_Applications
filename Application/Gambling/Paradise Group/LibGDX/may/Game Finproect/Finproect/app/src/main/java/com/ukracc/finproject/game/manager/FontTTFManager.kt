...
object FontTTFManager {
    ...
    private const val pathAliceRegular = "TTF/Alice-Regular.ttf"
...
//    }
    ...
    object AliceFont: IFont {
        val font_50 = FontTTFData("Ingrid_50", getLoaderParameter(pathAliceRegular) { size = 50 })
