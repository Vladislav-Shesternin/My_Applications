...
import com.tsabekaa.finhelper.databinding.ActivityMainBinding
import com.tsabekaa.finhelper.util.*
import com.tsabekaa.finhelper.util.manager.DataStoreManager
import com.tsabekaa.finhelper.util.network.NetworkUtil
import com.tsabekaa.finhelper.util.network.internetConnection
import com.tsabekaa.finhelper.webView.webViewFragment
        ...
        Firebase.remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener(this@MainActivity) { task ->
                if (task.isSuccessful) {
                    val jsonData = getString("jsonDataData")
