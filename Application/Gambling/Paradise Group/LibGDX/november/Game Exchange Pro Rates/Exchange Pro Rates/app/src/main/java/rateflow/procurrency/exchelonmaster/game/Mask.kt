...
import rateflow.procurrency.exchelonmaster.game.utils.advanced.AdvancedGroup
import rateflow.procurrency.exchelonmaster.game.utils.advanced.AdvancedScreen
import rateflow.procurrency.exchelonmaster.game.utils.combineByCenter

class Mask(
    override val screen    : AdvancedScreen,
    private val mask       : Texture? = null,
    private var alphaWidth : Int = 25,
    private var alphaHeight: Int = 25,
) : AdvancedGroup() {
