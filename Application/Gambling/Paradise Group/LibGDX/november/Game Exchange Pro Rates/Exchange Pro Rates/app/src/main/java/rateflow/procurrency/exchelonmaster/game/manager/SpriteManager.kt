...
class SpriteManager(var assetManager: AssetManager) {
    ...
    enum class EnumAtlas(val data: AtlasData) {
        GAME(AtlasData("mappa/mapka.atlas")),
    }

    enum class EnumTexture(val data: TextureData) {
        AlphaA(       TextureData("textures/AlphaA.png")             ),
        Golem(        TextureData("textures/Golem.png")             ),
        maswa(        TextureData("textures/maswa.png")             ),
        ResultOprosa( TextureData("textures/ResultOprosa.png")       ),
    }
