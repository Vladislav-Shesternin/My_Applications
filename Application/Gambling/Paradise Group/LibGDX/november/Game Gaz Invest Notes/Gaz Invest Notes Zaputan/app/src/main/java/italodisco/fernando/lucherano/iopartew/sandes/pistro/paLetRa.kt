package italodisco.fernando.lucherano.iopartew.sandes.pistro
...
import italodisco.fernando.lucherano.iopartew.pppp098.actor.setFillParent

open class paLetRa(viewport: Viewport) : Stage(viewport) {
