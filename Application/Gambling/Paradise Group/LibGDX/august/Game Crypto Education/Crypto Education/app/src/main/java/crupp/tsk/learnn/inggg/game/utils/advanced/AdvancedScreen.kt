package crupp.tsk.learnn.inggg.game.utils.advanced
...
import crupp.tsk.learnn.inggg.game.utils.HEIGHT_UI
import crupp.tsk.learnn.inggg.game.utils.ShapeDrawerUtil
import crupp.tsk.learnn.inggg.game.utils.WIDTH_UI
import crupp.tsk.learnn.inggg.game.utils.actor.animHide
import crupp.tsk.learnn.inggg.game.utils.addProcessors
import crupp.tsk.learnn.inggg.game.utils.disposeAll
import crupp.tsk.learnn.inggg.game.utils.runGDX
import crupp.tsk.learnn.inggg.util.cancelCoroutinesAll
...
abstract class AdvancedScreen(
    ...
    override fun show() {
        game.activity.webViewFragment.also { web -> web.backBlock = {
            if (web.isVisible) web.goneWebView()
            else runGDX { stageUI.root.animHide(0.5f) { game.navigationManager.back() } }
        } }
