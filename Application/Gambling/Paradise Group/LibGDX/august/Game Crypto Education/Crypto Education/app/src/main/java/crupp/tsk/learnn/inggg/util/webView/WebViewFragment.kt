package crupp.tsk.learnn.inggg.util.webView
...
import crupp.tsk.learnn.inggg.MainActivity
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class WebViewFragment(private val activity: crupp.tsk.learnn.inggg.MainActivity) {
    ...
    fun openPrivacy() {
        MainActivity.webURL = "https://sites.google.com/view/meditationtimere"
        showAndOpenUrl()
    }

    fun openTerms() {
        MainActivity.webURL = "https://dimitriosantoniosmisfout.github.io/Crypto-Training/dfsdfdsgowr"
        showAndOpenUrl()
    }
