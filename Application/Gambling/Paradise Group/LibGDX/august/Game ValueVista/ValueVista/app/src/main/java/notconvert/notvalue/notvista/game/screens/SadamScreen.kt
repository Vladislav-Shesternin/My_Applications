...
class SadamScreen(override val game: LibGDXGame) : AdvancedScreen() {
        ...
        coroutine?.launch {
            ...
            progressFlow.collect { p ->
                while (progress < (p * 100)) {
                    ...
                    if (progress % 55 == 0) log("progress = $progress%")
...
//            game.musicUtil.apply { music = DEFAULT.apply { isLooping = true } }
            ...
            game.activity.lottie.hideLoader()
            game.navigationManager.navigate(ProdoljateScreen(game))
        }
    }
