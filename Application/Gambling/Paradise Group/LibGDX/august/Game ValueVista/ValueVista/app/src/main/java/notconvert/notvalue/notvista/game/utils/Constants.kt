package notconvert.notvalue.notvista.game.utils

const val WIDTH_UI     = 598f
const val HEIGHT_UI    = 1294f
//const val WIDTH_BOX2D  = 40.96f
...
//
//const val TIME_ANIM_ALPHA = 0.5f
