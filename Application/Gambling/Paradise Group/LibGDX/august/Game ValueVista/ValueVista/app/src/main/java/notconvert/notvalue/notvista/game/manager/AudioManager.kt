package notconvert.notvalue.notvista.game.manager
...
object AudioManager {
    ...
    val audioManager   by lazy { notconvert.notvalue.notvista.appContext.getSystemService(Context.AUDIO_SERVICE) as AudioManager }
