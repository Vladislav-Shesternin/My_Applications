package com.lohina.titantreasuretrove
...
import com.lohina.titantreasuretrove.databinding.ActivityMainBinding
import com.lohina.titantreasuretrove.util.Lottie
import com.lohina.titantreasuretrove.util.Once
import com.lohina.titantreasuretrove.util.internetConnection
import com.lohina.titantreasuretrove.util.log
import com.lohina.titantreasuretrove.util.webView.WebViewFragment
                    ...
                    startFragmentIdFlow.collect { fragmentId ->
                        when (fragmentId) {
                            R.id.libGDXFragment -> {
                                ...
                                setNavigationBarColor(R.color.game)
