...
class SpriteManager(var assetManager: AssetManager) {
    ...
    enum class EnumTexture(override val data: TextureData): ITexture {
        BACKGROUND_A(     TextureData("textures/background a.png")    ),
        BACKGROUND_BLACK( TextureData("textures/background black.png")),
        BACKGROUND_WHITE( TextureData("textures/background white.png")),
    }
