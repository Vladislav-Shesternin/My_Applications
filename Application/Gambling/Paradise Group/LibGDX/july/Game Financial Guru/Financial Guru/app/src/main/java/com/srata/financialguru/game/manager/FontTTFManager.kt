...
//    }
    ...
    object GilMed: IFont {
        val font_70 = FontTTFData("GilMed_70", getLoaderParameter(pathGilroyMedium) { size = 70 })
        val font_28 = FontTTFData("GilMed_28", getLoaderParameter(pathGilroyMedium) { size = 28 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_70, font_28)
    }
