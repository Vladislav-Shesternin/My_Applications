...
//    }
    ...
    object GilRegularro: IFont {
        val font_83 = FontTTFData("GilRegularro_83", getLoaderParameter(pathGilroy_Regular) { size = 83 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_83)
    }

    object GilMediummo: IFont {
        val font_125 = FontTTFData("GilMediummo_125", getLoaderParameter(pathGilroy_Medium) { size = 125 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_125)
    }
