package com.forvovim.smartconverter.game.utils.advanced
...
import com.forvovim.smartconverter.game.utils.addProcessors
import com.forvovim.smartconverter.game.utils.disposeAll
import com.forvovim.smartconverter.util.cancelCoroutinesAll
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers


abstract class AdvancedScreen(
    val WIDTH : Float = 615f,
    val HEIGHT: Float = 1368f
    ...
    override fun keyDown(keycode: Int): Boolean {
        if (keycode == Input.Keys.BACK) mainGroup.animHide(0.5f) { NavigationManager.back() }
