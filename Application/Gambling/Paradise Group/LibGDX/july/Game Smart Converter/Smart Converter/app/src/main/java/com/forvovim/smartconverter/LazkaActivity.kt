package com.forvovim.smartconverter
...
import com.forvovim.smartconverter.util.*
import com.forvovim.smartconverter.util.manager.DataStoreManager
import com.forvovim.smartconverter.util.network.internetConnection
import com.forvovim.smartconverter.webView.webViewFragment
...
class LazkaActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    companion object {

        @SuppressLint("StaticFieldLeak") lateinit var navController: NavController
        lateinit var binding: KakToTakBinding
...
//                                }
    ...
    private fun initialize() {
        binding = KakToTakBinding.inflate(layoutInflater)
    ...
    fun setNavigationBarColor(@ColorRes colorId: Int) {
        coroutine.launch(Dispatchers.Main) { window.navigationBarColor = ContextCompat.getColor(this@LazkaActivity, colorId) }
    }
