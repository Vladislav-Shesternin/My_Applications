package com.prochenkoa.businessplanner
...
import com.prochenkoa.businessplanner.util.*
import com.prochenkoa.businessplanner.util.manager.DataStoreManager
import com.prochenkoa.businessplanner.util.network.internetConnection
...
class MercedesActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private fun initialize() {
        binding = XamarinkaBinding.inflate(layoutInflater)
    ...
    private fun setNavigationBarColor(@ColorRes colorId: Int) {
        coroutine.launch(Dispatchers.Main) { window.navigationBarColor = ContextCompat.getColor(this@MercedesActivity, colorId) }
    }
