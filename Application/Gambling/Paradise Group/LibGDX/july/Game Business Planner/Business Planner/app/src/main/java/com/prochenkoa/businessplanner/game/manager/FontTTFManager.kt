...
//    }
    ...
    object Regular: IFont {
        val font_32 = FontTTFData("Regular", getLoaderParameter(pathGilroy_Regular) { size = 32 })
    ...
    object Semibold: IFont {
        val font_41 = FontTTFData("Semibold", getLoaderParameter(pathGilroy_Semibold) { size = 41 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_41)
    }
