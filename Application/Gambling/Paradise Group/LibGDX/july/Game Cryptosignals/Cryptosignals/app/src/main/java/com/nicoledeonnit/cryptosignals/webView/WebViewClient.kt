package com.nicoledeonnit.cryptosignals.webView
...
class WebViewClient(val activity: MiniActivity): WebViewClient() {
    ...
    override fun shouldOverrideUrlLoading(view: WebView?, url: String): Boolean {
        when {
            ...
            Uri.parse(url).host == "localhost" -> {
                MiniActivity.startFragmentIdFlow.tryEmit(R.id.libGDXFragment)
            }
