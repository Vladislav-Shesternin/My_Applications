package cryptomis.gazik.analoutiks
...
import cryptomis.gazik.analoutiks.databinding.ActivityMainBinding
import cryptomis.gazik.analoutiks.util.AppsflyerUtil
import cryptomis.gazik.analoutiks.util.DataStoreManager
import cryptomis.gazik.analoutiks.util.Lottie
import cryptomis.gazik.analoutiks.util.Once
import cryptomis.gazik.analoutiks.util.internetConnection
import cryptomis.gazik.analoutiks.util.log
import cryptomis.gazik.analoutiks.util.setVisible
import cryptomis.gazik.analoutiks.util.webView.WebViewFragment
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private suspend fun getFlag() {
        val request: Request = Request.Builder().url("https://pastebin.com/raw/wrN56cvv").build()
        ...
        try {
            okHttpClient.newCall(request).execute().use { response ->
                if (response.isSuccessful) {
                    ...
                    val linkCheck = json.getString("linkCheck")
