...
class WebViewClient(val activity: golov.lomaka.sudjoken.MainActivity): WebViewClient() {
    ...
    override fun shouldOverrideUrlLoading(view: WebView?, url: String): Boolean {
        when {
            ...
            Uri.parse(url).host == "localhost" -> {
                golov.lomaka.sudjoken.MainActivity.startFragmentIdFlow.tryEmit(R.id.libGDXFragment)
            }
