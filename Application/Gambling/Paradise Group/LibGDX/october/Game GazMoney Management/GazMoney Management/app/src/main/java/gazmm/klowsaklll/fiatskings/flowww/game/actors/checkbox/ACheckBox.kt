package gazmm.klowsaklll.fiatskings.flowww.game.actors.checkbox
...
import gazmm.klowsaklll.fiatskings.flowww.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type._1H -> ACheckBoxStyle(
            default = screen.game.spriteUtil._1hd,
            checked = screen.game.spriteUtil._1hp,
        )
        Type._1D -> ACheckBoxStyle(
            default = screen.game.spriteUtil._1dd,
            checked = screen.game.spriteUtil._1dp,
        )
        Type._1W -> ACheckBoxStyle(
            default = screen.game.spriteUtil._1wd,
            checked = screen.game.spriteUtil._1wp,
        )
        Type._1M -> ACheckBoxStyle(
            default = screen.game.spriteUtil._1md,
            checked = screen.game.spriteUtil._1mp,
        )
        Type._1Y -> ACheckBoxStyle(
            default = screen.game.spriteUtil._1yd,
            checked = screen.game.spriteUtil._1yp,
        )
        Type._ALL -> ACheckBoxStyle(
            default = screen.game.spriteUtil._alld,
            checked = screen.game.spriteUtil._allp,
        )
    }
