package gazmm.klowsaklll.fiatskings.flowww.game.utils.font
...
object FontPath {
    const val Bold     = "font/Gilroy-Bold.ttf"
    const val Regular  = "font/Gilroy-Regular.ttf"
    const val Semibold = "font/Gilroy-Semibold.ttf"
}