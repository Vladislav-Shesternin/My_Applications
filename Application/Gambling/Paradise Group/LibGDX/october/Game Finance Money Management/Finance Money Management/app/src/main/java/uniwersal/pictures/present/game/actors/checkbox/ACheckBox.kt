package uniwersal.pictures.present.game.actors.checkbox
...
import uniwersal.pictures.present.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type._1H  -> ACheckBoxStyle(
            ...
            checked = screen.game.spriteUtil.HH,
        )
        Type._1D  -> ACheckBoxStyle(
            default = TextureEmpty.region,
            checked = screen.game.spriteUtil.DD,
        )
        Type._1W  -> ACheckBoxStyle(
            default = TextureEmpty.region,
            checked = screen.game.spriteUtil.WW,
        )
        Type._1M  -> ACheckBoxStyle(
            default = TextureEmpty.region,
            checked = screen.game.spriteUtil.MM,
        )
        Type._1Y  -> ACheckBoxStyle(
            default = TextureEmpty.region,
            checked = screen.game.spriteUtil.YY,
        )
        Type._ALL -> ACheckBoxStyle(
            default = TextureEmpty.region,
            checked = screen.game.spriteUtil.ALL,
        )
    }
