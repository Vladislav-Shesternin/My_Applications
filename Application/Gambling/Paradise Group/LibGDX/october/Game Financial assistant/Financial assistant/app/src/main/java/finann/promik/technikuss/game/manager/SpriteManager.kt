...
class SpriteManager(var assetManager: AssetManager) {
    ...
    enum class EnumTexture(val data: TextureData) {
        FINISHBACKGROUND(TextureData("textures/finishbackground.png")),
        HELLOBACKGROUND( TextureData("textures/hellobackground.png") ),
        QUIZBACKGROUND(  TextureData("textures/quizbackground.png")  ),
    }
