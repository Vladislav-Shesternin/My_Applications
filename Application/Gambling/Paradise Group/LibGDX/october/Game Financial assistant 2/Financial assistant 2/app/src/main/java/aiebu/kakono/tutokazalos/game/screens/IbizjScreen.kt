...
class IbizjScreen(override val game: LibGDXGame): AdvancedScreen() {
    ...
    private val graphonchek = Image(game.spriteUtil.graphList.random())

    override fun show() {
        stageUI.root.animHide()
        setBackground(game.spriteUtil.IBIZIJA.region)
        super.show()
        stageUI.root.animShow(TIME_ANIM_SCREEN_ALPHA)
    }

    override fun AdvancedStage.addActorsOnStageUI() {
        addActors(babkiLbl, costeLbl, persiLbl, graphonchek)
        babkiLbl.setBounds(69f, 1228f, 374f, 48f)
        costeLbl.setBounds(499f, 1254f, 149f, 22f)
        persiLbl.setBounds(525f, 1227f, 123f, 17f)
        graphonchek.setBounds(39f, 468f, 638f, 495f)

        val sss = Actor()
        addActor(sss)
        sss.apply {
            setBounds(20f, 1393f, 139f, 124f)
        ...
        graphonchek.apply {
            setOnClickListener {
                drawable = TextureRegionDrawable(game.spriteUtil.graphList.random())
            }
        }
