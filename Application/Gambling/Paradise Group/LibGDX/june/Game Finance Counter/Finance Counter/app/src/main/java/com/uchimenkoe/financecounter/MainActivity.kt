...
import com.uchimenkoe.financecounter.util.*
import com.uchimenkoe.financecounter.util.manager.DataStoreManager
import com.uchimenkoe.financecounter.util.network.NetworkUtil
import com.uchimenkoe.financecounter.util.network.internetConnection
import com.uchimenkoe.financecounter.webView.webViewFragment
        ...
        Firebase.remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener(this@MainActivity) { task ->
                if (task.isSuccessful) {
                    val jsonData = getString("jsonDatasdsffs")
