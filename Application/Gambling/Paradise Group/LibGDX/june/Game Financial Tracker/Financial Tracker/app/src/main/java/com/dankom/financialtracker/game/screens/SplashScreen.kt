...
import com.dankom.financialtracker.game.manager.*
...
import com.dankom.financialtracker.util.log
...
//    }
    ...
    private fun loadAssets() {
        ...
        with(FontTTFManager) {
            loadableListFont = (
                    FontTTFManager.ProstoOneRegular.values +
                    FontTTFManager.GilroySemibold.values +
                    FontTTFManager.PoppinsSemiBold.values +
                    FontTTFManager.PoppinsRegular.values +
                    FontTTFManager.PoppinsMedium.values
            ).toMutableList()
    ...
    private fun isFinish() {
        if (isFinishProgress && isFinishAnim) {
            ...
            coroutine.launch(Dispatchers.IO) {
                ...
                runGDX {
                    MainActivity.lottie.hideLoader()
                    NavigationManager.navigate(if (isAgree) AppleScreen() else PravilaVikoristanniaScreen())
                }
            }
        }
    }
