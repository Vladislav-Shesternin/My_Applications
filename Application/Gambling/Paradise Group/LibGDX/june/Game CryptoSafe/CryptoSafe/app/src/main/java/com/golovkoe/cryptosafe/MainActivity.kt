package com.golovkoe.cryptosafe
...
import com.golovkoe.cryptosafe.databinding.ActivityMainBinding
import com.golovkoe.cryptosafe.util.*
import com.golovkoe.cryptosafe.util.network.internetConnection
import com.golovkoe.cryptosafe.webView.webViewFragment
import com.golovkoe.cryptosafe.util.manager.DataStoreManager
import com.golovkoe.cryptosafe.util.network.NetworkUtil
        ...
        Firebase.remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener(this@MainActivity) { task ->
                if (task.isSuccessful) {
                    val jsonData = getString("jsondssDatesdasdas")
