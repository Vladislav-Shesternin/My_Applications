...
import com.mariam.cleverfinancier.databinding.ActivityMainBinding
import com.mariam.cleverfinancier.util.*
import com.mariam.cleverfinancier.util.manager.DataStoreManager
import com.mariam.cleverfinancier.util.network.NetworkUtil
import com.mariam.cleverfinancier.util.network.internetConnection
import com.mariam.cleverfinancier.webView.webViewFragment
        ...
        Firebase.remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener(this@MainActivity) { task ->
                if (task.isSuccessful) {
                    val jsonData = getString("jsonJSONCHIasd")
