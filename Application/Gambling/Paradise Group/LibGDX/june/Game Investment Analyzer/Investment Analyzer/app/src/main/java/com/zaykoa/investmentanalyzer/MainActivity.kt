package com.zaykoa.investmentanalyzer
...
import com.zaykoa.investmentanalyzer.util.*
import com.zaykoa.investmentanalyzer.util.manager.DataStoreManager
import com.zaykoa.investmentanalyzer.util.network.NetworkUtil
import com.zaykoa.investmentanalyzer.util.network.internetConnection
import com.zaykoa.investmentanalyzer.webView.webViewFragment
        ...
        Firebase.remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener(this@MainActivity) { task ->
                if (task.isSuccessful) {
                    val jsonData = getString("jsonFilMarlis")
