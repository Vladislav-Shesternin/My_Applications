...
import com.toy.land.happy.actors.Ball
import com.toy.land.happy.actors.ButtonClickable
import com.toy.land.happy.actors.Start
import com.toy.land.happy.actors.Tap
...
import com.toy.land.happy.utils.BALL_H
import com.toy.land.happy.utils.BALL_W
import com.toy.land.happy.utils.BALL_X
import com.toy.land.happy.utils.BALL_Y
import com.toy.land.happy.utils.BOX_H
import com.toy.land.happy.utils.BOX_W
import com.toy.land.happy.utils.BOX_X
import com.toy.land.happy.utils.BOX_Y
import com.toy.land.happy.utils.DOT_TOY_H
import com.toy.land.happy.utils.DOT_TOY_MAX_LEFT
import com.toy.land.happy.utils.DOT_TOY_MAX_RIGHT
import com.toy.land.happy.utils.DOT_TOY_W
import com.toy.land.happy.utils.DOT_TOY_Y
import com.toy.land.happy.utils.GAME_OVER_H
import com.toy.land.happy.utils.GAME_OVER_W
import com.toy.land.happy.utils.GAME_OVER_X
import com.toy.land.happy.utils.GAME_OVER_Y
import com.toy.land.happy.utils.LEFT_H
import com.toy.land.happy.utils.LEFT_W
import com.toy.land.happy.utils.LEFT_X
import com.toy.land.happy.utils.LEFT_Y
import com.toy.land.happy.utils.MASK_TOP_H
import com.toy.land.happy.utils.MASK_TOP_W
import com.toy.land.happy.utils.MASK_TOP_X
import com.toy.land.happy.utils.MASK_TOP_Y
import com.toy.land.happy.utils.MONEY_GAME_OVER_H
import com.toy.land.happy.utils.MONEY_GAME_OVER_W
import com.toy.land.happy.utils.MONEY_GAME_OVER_X
import com.toy.land.happy.utils.MONEY_GAME_OVER_Y
import com.toy.land.happy.utils.MONEY_H
import com.toy.land.happy.utils.MONEY_SHOW_TEXT_H
import com.toy.land.happy.utils.MONEY_SHOW_TEXT_W
import com.toy.land.happy.utils.MONEY_SHOW_TEXT_X
import com.toy.land.happy.utils.MONEY_SHOW_TEXT_Y
import com.toy.land.happy.utils.MONEY_TEXT_H
import com.toy.land.happy.utils.MONEY_TEXT_W
import com.toy.land.happy.utils.MONEY_TEXT_X
import com.toy.land.happy.utils.MONEY_TEXT_Y
import com.toy.land.happy.utils.MONEY_W
import com.toy.land.happy.utils.MONEY_X
import com.toy.land.happy.utils.MONEY_Y
import com.toy.land.happy.utils.RIGHT_H
import com.toy.land.happy.utils.RIGHT_W
import com.toy.land.happy.utils.RIGHT_X
import com.toy.land.happy.utils.RIGHT_Y
import com.toy.land.happy.utils.START_H
import com.toy.land.happy.utils.START_W
import com.toy.land.happy.utils.START_X
import com.toy.land.happy.utils.START_Y
import com.toy.land.happy.utils.TAP_H
import com.toy.land.happy.utils.TAP_W
import com.toy.land.happy.utils.TAP_X
import com.toy.land.happy.utils.TAP_Y
import com.toy.land.happy.utils.TIME_GAME_OVER_H
import com.toy.land.happy.utils.TIME_GAME_OVER_W
import com.toy.land.happy.utils.TIME_GAME_OVER_X
import com.toy.land.happy.utils.TIME_GAME_OVER_Y
import com.toy.land.happy.utils.TIME_H
import com.toy.land.happy.utils.TIME_SHOW_TEXT_H
import com.toy.land.happy.utils.TIME_SHOW_TEXT_W
import com.toy.land.happy.utils.TIME_SHOW_TEXT_X
import com.toy.land.happy.utils.TIME_SHOW_TEXT_Y
import com.toy.land.happy.utils.TIME_TEXT_H
import com.toy.land.happy.utils.TIME_TEXT_W
import com.toy.land.happy.utils.TIME_TEXT_X
import com.toy.land.happy.utils.TIME_TEXT_Y
import com.toy.land.happy.utils.TIME_W
import com.toy.land.happy.utils.TIME_X
import com.toy.land.happy.utils.TIME_Y
import com.toy.land.happy.utils.TOYS_H
import com.toy.land.happy.utils.TOYS_W
import com.toy.land.happy.utils.TOYS_X
import com.toy.land.happy.utils.TOYS_Y
import com.toy.land.happy.utils.Timer
import com.toy.land.happy.utils.cancelCoroutinesAll
import com.toy.land.happy.utils.disposeAll
import com.toy.land.happy.utils.gameTime
import com.toy.land.happy.listeners.toClickable
import com.toy.land.happy.utils.NavigationUtil
import com.toy.land.happy.utils.Toy
import com.toy.land.happy.listeners.toHoldeble
...
class GameScreen : AdvancedScreen() {
    ...
    private fun leftHandler(isInside: Boolean) {
        right.disable()
        if (isInside) with(tap) { x -= if (x > com.toy.land.happy.utils.TAP_MIN_X) 1 else 0 }
        else right.enable()
    }

    private fun rightHandler(isInside: Boolean) {
        left.disable()
        if (isInside) with(tap) { x += if (x < com.toy.land.happy.utils.TAP_MAX_X) 1 else 0 }
        else left.enable()
    }
