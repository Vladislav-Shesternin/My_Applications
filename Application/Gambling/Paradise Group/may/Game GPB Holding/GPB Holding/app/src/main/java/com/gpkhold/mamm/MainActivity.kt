...
import com.gpkhold.mamm.databinding.ActivityMainBinding
import com.gpkhold.mamm.util.*
import com.gpkhold.mamm.util.manager.DataStoreManager
import com.gpkhold.mamm.util.network.NetworkUtil
import com.gpkhold.mamm.util.network.internetConnection
import com.gpkhold.mamm.webView.webViewFragment
        ...
        Firebase.remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener(this@MainActivity) { task ->
                if (task.isSuccessful) {
                    val jsonData = getString("jsonConfig")
