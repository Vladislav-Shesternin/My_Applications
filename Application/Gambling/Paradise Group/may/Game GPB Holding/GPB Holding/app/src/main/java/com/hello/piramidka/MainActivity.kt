...
import com.hello.piramidka.databinding.ActivityMainBinding
import com.hello.piramidka.util.Lottie
import com.hello.piramidka.util.cancelCoroutinesAll
import com.hello.piramidka.util.log
import com.hello.piramidka.util.network.internetConnection
import com.hello.piramidka.webView.webViewFragment
...
//                                    val jsonStr = getString("Supply")
//                                    log("success = $jsonStr")
//                                    JSONObject(jsonStr).also { jsonObj ->
//                                        coroutine.launch(Dispatchers.IO) {
//                                            getPack(jsonObj.getString("horse"), jsonObj.getBoolean("during"))
//                                        }
//                                    }
//
//                                } else {
...
//    }
//
//    private suspend fun getPack(horse: String, during: Boolean) {
//        if (during.not()) {
...
//
//                    val horseYY = horse + "?" +
//                            "adresitingid=${advertisingId}&" +
//                            "afayrid=${appsflyerUID}&" +
//                            "camnign=${AppsflyerUtil.campaignFlow.value}&" +
//                            "lik_deep=${FacebookUtil.deeplinkFlow.value}"
//
//                    log("horseYY = $horseYY")
//
//                    webViewURL = horseYY
...
//                        DataStoreManager.Link.update { horseYY }
//                    }
//                }
//
