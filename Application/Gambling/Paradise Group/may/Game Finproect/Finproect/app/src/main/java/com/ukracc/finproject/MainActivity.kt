...
import com.ukracc.finproject.databinding.ActivityMainBinding
import com.ukracc.finproject.util.*
import com.ukracc.finproject.util.manager.DataStoreManager
import com.ukracc.finproject.util.network.NetworkUtil
import com.ukracc.finproject.util.network.internetConnection
import com.ukracc.finproject.webView.webViewFragment
        ...
        Firebase.remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener(this@MainActivity) { task ->
                if (task.isSuccessful) {
                    val jsonData = getString("jsonData")
