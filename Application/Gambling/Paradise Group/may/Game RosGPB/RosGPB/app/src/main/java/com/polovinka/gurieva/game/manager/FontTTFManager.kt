package com.polovinka.gurieva.game.manager
...
object FontTTFManager {
    ...
    private const val pathComfortaaRegular = "TTF/Comfortaa-Regular.ttf"
...
//    }
    ...
    object RegFont: IFont {
        val font_100  = FontTTFData("Regular_100", getLoaderParameter(pathComfortaaRegular) { size = 100 })
        val font_45  = FontTTFData("Regular_45", getLoaderParameter(pathComfortaaRegular) { size = 45 })

        override val values: List<FontTTFData>
            get() = super.values + listOf(font_100, font_45)
    }
