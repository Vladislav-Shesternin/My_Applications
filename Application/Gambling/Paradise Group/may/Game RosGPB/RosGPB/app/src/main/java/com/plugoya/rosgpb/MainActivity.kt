...
import com.plugoya.rosgpb.databinding.ActivityMainBinding
import com.plugoya.rosgpb.util.*
import com.plugoya.rosgpb.util.network.internetConnection
import com.plugoya.rosgpb.webView.webViewFragment
import com.plugoya.rosgpb.util.manager.DataStoreManager
import com.plugoya.rosgpb.util.network.NetworkUtil
        ...
        Firebase.remoteConfig.apply {
            ...
            fetchAndActivate().addOnCompleteListener(this@MainActivity) { task ->
                if (task.isSuccessful) {
                    val jsonData = getString("jsonConf")
