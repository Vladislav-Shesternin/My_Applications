...
private val rouletteItemList = listOf<SuperGameRouletteItem>(
    SuperGameRouletteItem(segment = (SEGMENT * 0f) + 0.0001f to (SEGMENT * 1f), number = 10),
    ...
    SuperGameRouletteItem(segment = (SEGMENT * 4f) + 0.0001f to (SEGMENT * 5f), number = 10),
...
class RouletteSpin: RouletteGroup<SuperGameRouletteItem>(
    rouletteRegion = SpriteManager.SuperGameRegion.ROULETTE_SPIN.region,
