package com.veldan.fantasticslots.actors.checkbox
...
class CheckBox(
    ...
    var checkBoxManager: CheckBoxGroup? = null
    ...
    private fun getListener() = object : InputListener() {
        ...
        override fun touchUp(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int) {
            if (isWithin) {
                ...
                if (checkBoxManager == null && checkFlow.value.not()) check() else uncheck()
            }
        }
    }
    ...
    fun enable() {
        Gdx.app.postRunnable { touchable = Touchable.enabled }
    }

    fun disable() {
        Gdx.app.postRunnable { touchable = Touchable.disabled }
    }
