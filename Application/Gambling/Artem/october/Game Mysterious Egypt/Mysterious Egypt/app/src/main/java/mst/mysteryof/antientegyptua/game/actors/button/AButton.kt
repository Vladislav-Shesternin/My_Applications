package mst.mysteryof.antientegyptua.game.actors.button
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        Type.PL -> AButtonStyle(
            ...
            pressed  = spriteUtil.PL_PRESS,
            disabled = spriteUtil.PL_PRESS,
        )
        Type.EX -> AButtonStyle(
            default  = spriteUtil.EX_DEF,
            pressed  = spriteUtil.EX_PRESS,
            disabled = spriteUtil.EX_PRESS,
        )
        Type.SN -> AButtonStyle(
            default  = spriteUtil.SN_DEF,
            pressed  = spriteUtil.SN_PRESS,
            disabled = spriteUtil.SN_PRESS,
        )
        Type.MN -> AButtonStyle(
            default  = spriteUtil.MN_DEF,
            pressed  = spriteUtil.MN_PRESS,
            disabled = spriteUtil.MN_PRESS,
        )
    }
