package mst.mysteryof.antientegyptua.util.webView
...
import mst.mysteryof.antientegyptua.MainActivity
...
class WebViewFragment(private val activity: MainActivity) {
    ...
    fun showAndOpenUrl() {
        ...
        coroutine?.launch(Dispatchers.Main) {
            ...
            webView?.loadUrl(MainActivity.pipijaNra)
        }
    }
