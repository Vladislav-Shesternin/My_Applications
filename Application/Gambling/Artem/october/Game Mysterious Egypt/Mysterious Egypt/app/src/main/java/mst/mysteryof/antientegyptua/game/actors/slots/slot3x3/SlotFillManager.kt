...
class SlotFillManager(
    ...
    private fun fillMix() {
        ...
        val combinationMatrix5x3: ICombinationMatrix3x3 = Combination3x3.Mix //if (Random().nextBoolean()) Combination5x3.Mix else Combination5x3.MixWithWild
        val matrix5x3Handler = Matrix3x3Handler(combinationMatrix5x3.getMatrixAndLog(), slotItemContainer)
    ...
    private fun fillWin() {
        ...
        val combinationMatrix5x3: ICombinationMatrix3x3 = Combination3x3.Win
