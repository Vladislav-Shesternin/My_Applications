...
import mst.mysteryof.egyptest.game.actors.slots.SlotItem
import mst.mysteryof.egyptest.game.utils.Layout
...
import mst.mysteryof.egyptest.game.utils.Layout.Slot as LS
...
class Slot(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    companion object {
        ...
        const val SLOT_ITEM_INTERMEDIATE_COUNT = 42

        const val TIME_SPIN_SLOT = 3.5f
    }
        ...
        (fakeSlotItemImageList.reversed() + intermediateSlotItemImageList + winSlotItemImageList.reversed()).onEachIndexed { index, slotItemImage ->
            ...
            slotItemImage.apply {
                ...
                with(LS.slot) {
                    ...
                    newY += h + vs + if (index == 44 || index == 2) 50 else 0
                }
            }
        }
    }
