package com.radarada.avia.util
...
object AppsflyerUtil {
    ...
    private const val APPSFLYER_DEV_KEY = "qVPNiutUknNxcgqsajZoab"
    ...
    const val ADID_INIT_VALUE = "none"
    val adidFlow = MutableStateFlow<String?>(ADID_INIT_VALUE)
    ...
    private val conversionListener = object : AppsFlyerConversionListener {
        override fun onConversionDataSuccess(conversionData: Map<String, Any>) {
            onceConversionDataSuccess.once {
                ...
                campaignFlow.value = getData("campaign") ?: getData("c")
                adidFlow.value     = getData("ad_id")
            }
        }
