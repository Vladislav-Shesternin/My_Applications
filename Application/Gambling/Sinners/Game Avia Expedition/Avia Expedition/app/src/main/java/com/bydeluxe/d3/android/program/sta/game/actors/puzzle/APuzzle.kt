package com.bydeluxe.d3.android.program.sta.game.actors.puzzle
...
import com.bydeluxe.d3.android.program.sta.game.utils.actor.disable
import com.bydeluxe.d3.android.program.sta.game.utils.actor.enable
...
class APuzzle(
    ...
    private fun getInputAdapter() = object : InputListener() {
        override fun touchDown(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int): Boolean {
            screen.game.soundUtil.apply { play(touch) }
            disable()
