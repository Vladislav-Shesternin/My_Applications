package atest.btest.lbjttest.game.actors.button
...
open class AButton(
    ...
    private val assets by lazy { screen.game.assets }
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.DEFAULT -> Static.AButtonStyle(
            default  = assets.C_DYNAMIC,
            pressed  = assets.C_DYNAMIC,
            disabled = assets.C_DYNAMIC,
        )
    }
