...
class MotorJointScreen(override val game: LibGDXGame): AdvancedMouseScreen(game) {

    // BodyGroup
    private val bgBorders    = BGBorders(this)
    private val bgMotorJoint = BGMotorJoint(this)
    ...
    override fun dispose() {
        listOf(bgBorders, bgMotorJoint).destroyAll()
        super.dispose()
    }
    ...
    private fun createBG_MotorJoint() {
        bgMotorJoint.create(615f,265f,170f,170f)
    }
