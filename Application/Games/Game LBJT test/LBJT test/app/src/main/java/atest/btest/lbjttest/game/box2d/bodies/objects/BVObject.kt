...
class BVObject(
    ...
    private fun getRegionByType(): TextureRegion = when (bodyType) {
        BodyType.StaticBody    -> screenBox2d.game.assets.V_STATIC
        BodyType.KinematicBody -> screenBox2d.game.assets.V_KINEMATIC
        BodyType.DynamicBody   -> screenBox2d.game.assets.V_DYNAMIC
    }
