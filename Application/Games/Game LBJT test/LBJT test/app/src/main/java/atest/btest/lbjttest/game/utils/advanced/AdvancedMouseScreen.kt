...
import atest.btest.lbjttest.game.box2d.bodies.standart.BStatic
import atest.btest.lbjttest.game.utils.actor.animHide
import atest.btest.lbjttest.game.utils.actor.animShow
import atest.btest.lbjttest.game.utils.actor.disable
import atest.btest.lbjttest.game.utils.currentTimeMinus
...
abstract class AdvancedMouseScreen(override val game: LibGDXGame): AdvancedBox2dScreen(WorldUtil()) {
    ...
    // Actor
    val user by lazy { Image(game.assets.USER) }
