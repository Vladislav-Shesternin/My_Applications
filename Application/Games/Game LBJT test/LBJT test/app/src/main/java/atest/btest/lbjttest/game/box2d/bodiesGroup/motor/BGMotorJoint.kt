package atest.btest.lbjttest.game.box2d.bodiesGroup.motor
...
class BGMotorJoint(override val screenBox2d: AdvancedBox2dScreen): AbstractBodyGroup() {
    ...
    private fun createB_Static() {
        createBody(bStaticCircle, 62f, 62f, 46f, 46f)
    }
