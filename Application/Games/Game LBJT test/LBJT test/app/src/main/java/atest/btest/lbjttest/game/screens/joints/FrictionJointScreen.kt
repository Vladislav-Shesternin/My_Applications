...
class FrictionJointScreen(override val game: LibGDXGame): AdvancedMouseScreen(game) {
    ...
    override fun AdvancedStage.addActorsOnStageUI() {
        createBG_Borders()
        createBG_FrictionJoint()

        stageUI.root.animShow(TIME_ANIM_SCREEN_ALPHA)
    }

    override fun dispose() {
        listOf(bgBorders, bgFrictionJoint).destroyAll()
        super.dispose()
    }
    ...
    private fun createBG_FrictionJoint() {
        bgFrictionJoint.create(615f,310f,170f,257f)
    }
