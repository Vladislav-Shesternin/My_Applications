...
class BGWeldJoint_1(override val screenBox2d: AdvancedBox2dScreen): AbstractBodyGroup() {
    ...
    private fun createB_Static() {
        createBody(bStaticVertical, 0f, 126f, 70f, 170f)
    }
    ...
    private fun createJ_Weld() {
        createJoint(jWeld, WeldJointDef().apply {
            ...
            localAnchorA.set(Vector2(35f, -91f).subCenter(bodyA))
