...
import com.liquidfun.playground.game.utils.SizeStandardizer
...
abstract class AbstractBodyGroup: Destroyable {
    ...
    protected fun AdvancedGroup.setBoundsStandartBG(xy: Vector2, wh: Vector2) {
        setBounds(position.cpy().add(xy.toStandartBG), wh.toStandartBG)
        _actorList.add(this)
    }
