package com.liquidfun.playground.game.actors.checkbox
...
import com.liquidfun.playground.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    open fun getListener() = object : InputListener() {
        ...
        override fun touchDown(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int): Boolean {
            screen.game.soundUtil.apply { play(DROP) }
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.DEFAULT -> Static.ACheckBoxStyle(
            ...
            checked = screen.game.allAssets.check,
        )
    }
