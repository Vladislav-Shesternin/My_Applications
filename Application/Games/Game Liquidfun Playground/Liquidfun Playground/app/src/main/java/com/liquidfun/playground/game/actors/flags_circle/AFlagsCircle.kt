...
class AFlagsCircle(override val screen: AdvancedScreen): AbstractFlagsCircle() {

    // Actor
    override val aCBoxList = List(12) { ACheckBoxTouch(screen, ACheckBox.Static.Type.DEFAULT) }
    override val aAreaList = List(12) { Actor() }
