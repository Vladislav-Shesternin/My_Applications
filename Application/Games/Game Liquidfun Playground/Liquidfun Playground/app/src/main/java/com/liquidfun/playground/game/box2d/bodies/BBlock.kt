...
class BBlock(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {
    ...
    override var actor: AdvancedGroup? = AImage(screenBox2d, screenBox2d.drawerUtil.getRegion(GameColor.brown))

    override var id = BodyId.BORDERS
    override val collisionList = mutableListOf(BodyId.DYNAMIC)
