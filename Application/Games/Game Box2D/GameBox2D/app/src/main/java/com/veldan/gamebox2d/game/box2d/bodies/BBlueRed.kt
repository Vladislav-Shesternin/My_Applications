...
class BBlueRed(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {

    override var id         = BLUE_RED
    override val name       = "blue_red"
    ...
    override val actor = AImage(SpriteManager.GameRegion.BLUE_RED.region)
}