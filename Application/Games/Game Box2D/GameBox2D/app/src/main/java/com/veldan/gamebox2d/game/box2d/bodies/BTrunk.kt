...
class BTrunk(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {

    override var id         = TRUNK
    override val name       = "trunk"
    ...
    override val actor = AImage(SpriteManager.GameRegion.TRUNK.region)
