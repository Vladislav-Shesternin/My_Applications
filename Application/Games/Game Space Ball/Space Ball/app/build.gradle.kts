...
android {
    signingConfigs {
        create("ogo") {
            storeFile =
                file("D:\\My_Applications\\Application\\Games\\Game Space Ball\\release\\spaceballrostenko.jks")
            keyAlias = "Rostenko"
            storePassword = "FlamenKoCertUn12431o"
            keyPassword = "FlamenKoCertUn12431o"
        }
    }
    ...
    defaultConfig {
        ...
        signingConfig = signingConfigs.getByName("ogo")
    }
