package com.hellhot.competition.game.box2d.bodies.leftButton
...
class LeftButton: AbstractBody() {
    override var id            = LEFT_BUTTON
    override val name          = "LeftButton"
    ...
    override val actor = AButton(AButtonStyle.left)
