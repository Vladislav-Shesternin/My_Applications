...
//    }
    ...
    object AkronimFont: IFont {
        override val font_65 = FontTTFData("Akronim_65", getLoaderParameter(pathAkronim) { size = 65 })
        override val font_50 = FontTTFData("Akronim_50", getLoaderParameter(pathAkronim) { size = 50 })
    }



    interface IFont {
        val font_65: FontTTFData
        val font_50: FontTTFData

        val values get() = listOf<FontTTFData>(font_65, font_50)
    }
