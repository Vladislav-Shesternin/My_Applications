package com.mesga.moolahit.game.manager
...
object FontTTFManager {
    ...
    private const val pathFont = "TTF/Font.ttf"
...
//    }
    ...
    object Font: IFont {
        override val font_100 = FontTTFData("Font_100", getLoaderParameter(pathFont) { size = 100 })
        override val font_25 = FontTTFData("Font_25", getLoaderParameter(pathFont) { size = 25 })
    }
    ...
    interface IFont {
        ...
        val values get() = listOf<FontTTFData>(font_100, font_25)
    }
