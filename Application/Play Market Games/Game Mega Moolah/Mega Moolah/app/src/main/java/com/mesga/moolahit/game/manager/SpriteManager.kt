...
object SpriteManager {
    ...
    enum class GameRegion(override val region: TextureRegion): IRegion {
        ...
        DUPLO(      EnumAtlas._1.data.atlas.findRegion("duplo")      ),
        ...
        BONUS(      EnumAtlas._1.data.atlas.findRegion("bonus")      ),
    }

    enum class ListRegion(override val regionList: List<TextureRegion>): IRegionList {
        ITEMS(List(10) { EnumAtlas._1.data.atlas.findRegion("${it.inc()}") }),
        S(List(36) { EnumAtlas._2.data.atlas.findRegion("${it.inc()}") }),
    }
