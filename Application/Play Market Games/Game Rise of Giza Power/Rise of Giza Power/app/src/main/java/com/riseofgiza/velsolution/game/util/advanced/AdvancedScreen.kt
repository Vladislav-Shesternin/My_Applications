package com.riseofgiza.velsolution.game.util.advanced
...
import com.riseofgiza.velsolution.game.util.HEIGHT
import com.riseofgiza.velsolution.game.util.WIDTH
import com.riseofgiza.velsolution.game.util.addProcessors
import com.riseofgiza.velsolution.game.util.disposeAll
...
abstract class AdvancedScreen : ScreenAdapter(), AdvancedInputProcessor {
    ...
    override fun keyDown(keycode: Int): Boolean {
        if (keycode == Input.Keys.BACK) SplashScreen.NavigationManager.back()
