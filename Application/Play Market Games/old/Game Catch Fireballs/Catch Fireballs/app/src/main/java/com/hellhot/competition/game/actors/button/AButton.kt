...
class AButton(
    ...
    private var onLongClickBlock: () -> Unit = { }

    private var longJob: Job? = null
    private var longDelayTime = 0L
    ...
    fun setOnLongClickListener(delayTime: Long = 0L, block: () -> Unit) {
        longDelayTime    = delayTime
        onLongClickBlock = block
    }
