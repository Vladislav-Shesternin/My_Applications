...
//    }
    ...
    object Font: IFont {
        override val font_120 = FontTTFData("Font_120", getLoaderParameter(pathFont) { size = 120 })
    ...
    interface IFont {
        val font_120: FontTTFData
        val font_25: FontTTFData

        val values get() = listOf<FontTTFData>(font_120, font_25)
    }
