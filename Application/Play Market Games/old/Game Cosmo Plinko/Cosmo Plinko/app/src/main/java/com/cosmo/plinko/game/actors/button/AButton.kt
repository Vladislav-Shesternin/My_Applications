...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.DEFAULT      -> Static.AButtonStyle(
            default  = assets.BTN_DEF,
            pressed  = assets.BTN_PRS,
            disabled = assets.BTN_PRS,
        )
        Static.Type.MENU      -> Static.AButtonStyle(
            default  = assets.MENU_DEF,
            pressed  = assets.MENU_PRS,
            disabled = assets.MENU_PRS,
        )
        Static.Type.PAUSE      -> Static.AButtonStyle(
            default  = assets.PAUSE_DEF,
            pressed  = assets.PAUSE_PRS,
            disabled = assets.PAUSE_PRS,
        )
    }
