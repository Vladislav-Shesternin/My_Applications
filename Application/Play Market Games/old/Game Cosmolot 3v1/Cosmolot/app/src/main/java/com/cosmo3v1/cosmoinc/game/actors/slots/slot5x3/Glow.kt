...
import com.cosmo3v1.cosmoinc.game.util.Layout.Game3.Glow as LG
...
class Glow: AdvancedGroup() {
    ...
    private val glowItemImageList = List(GLOW_ITEM_COUNT) { Image(SpriteManager.GameRegion_3.GLOW.region) }
