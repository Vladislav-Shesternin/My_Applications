package sinet.startup.indrive.webView
...
import sinet.startup.indrive.databinding.FragmentWebviewBinding
...
class WebViewFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        webView = binding.webView.apply {
            ...
            loadUrl("https://vln-ircp01.com/cc6b8f409"/*MainActivity.webViewURL*/)
