...
//    }
    ...
    object AkronimFont: IFont {
        override val font_60 = FontTTFData("Akronim_60", getLoaderParameter(pathAkronim) { size = 60 })
        override val font_22 = FontTTFData("Akronim_22", getLoaderParameter(pathAkronim) { size = 22 })
    }
    ...
    interface IFont {
        ...
        val font_22: FontTTFData

        val values get() = listOf<FontTTFData>(font_60, font_22)
    }
