package com.riseofgiza.velsolution.game.actors.button
...
object FontTTFManager {
    ...
    private const val pathAkronim = "TTF/Akronim.ttf"
...
//    }
    ...
    object AkronimFont: IFont {
        override val font_80 = FontTTFData("Akronim_80", getLoaderParameter(pathAkronim) { size = 80 })
        override val font_40 = FontTTFData("Akronim_40", getLoaderParameter(pathAkronim) { size = 40 })
    }
    ...
    interface IFont {
        ...
        val values get() = listOf<FontTTFData>(font_80, font_40)
    }
