...
class SlotGroup: AdvancedGroup() {
    ...
    companion object {
        ...
        const val TIME_WAIT_AFTER_SHOW_WIN = 0.7f
        const val TIME_GLOW_IN = 0.25f
        const val TIME_GLOW_OUT = 0.25f
        const val TIME_BETWEEN_GLOW_IN = 0.1f
    }
