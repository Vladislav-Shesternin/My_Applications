package com.guardians.galaxyguano.game.box2d.bodiesGroup

import com.guardians.galaxyguano.game.box2d.AbstractBodyGroup
import com.guardians.galaxyguano.game.box2d.BodyId
import com.guardians.galaxyguano.game.box2d.bodies.BHorizontal
import com.guardians.galaxyguano.game.box2d.bodies.BVertical
...
class BGBorders(override val screenBox2d: AdvancedBox2dScreen) : AbstractBodyGroup() {
    ...
    private fun initB_Borders() {
        ...
        bDown.collisionList.add(BodyId.BALL)
    }
