...
class BDList(override val screenBox2d: AdvancedBox2dScreen, index: Int): AbstractBody() {
    override val name       = "d${index.inc()}"
    ...
    override var actor: AdvancedGroup? = AImage(screenBox2d, screenBox2d.game.assets.dList[index])
}