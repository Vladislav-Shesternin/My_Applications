...
class BSettingsBtn(override val screenBox2d: AdvancedBox2dScreen): AbstractBody() {
    ...
    override var actor: AdvancedGroup? = AButton(screenBox2d, AButton.Static.Type.SETTINGS)
